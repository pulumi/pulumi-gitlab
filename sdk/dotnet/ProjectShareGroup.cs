...
namespace Pulumi.GitLab
{
    ...
    /// {
    ///     var test = new GitLab.Index.ProjectShareGroup("test", new()
    ///     {
    ///         Project = "12345",
    ///         GroupId = 1337,
    ///         GroupAccess = "guest",
    ...
    /// ## Import
    /// 
    /// Starting in Terraform v1.5.0, you can use an import block to import `gitlab.ProjectShareGroup`. For example:
    /// 
