...
namespace Pulumi.GitLab
{
    ...
    public partial class ServiceExternalWiki : global::Pulumi.CustomResource
    {
        ...
        public ServiceExternalWiki(string name, ServiceExternalWikiArgs args, CustomResourceOptions? options = null)
            : base("gitlab:index/serviceExternalWiki:ServiceExternalWiki", name, args ?? new ServiceExternalWikiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceExternalWiki(string name, Input<string> id, ServiceExternalWikiState? state = null, CustomResourceOptions? options = null)
            : base("gitlab:index/serviceExternalWiki:ServiceExternalWiki", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ServiceExternalWiki Get(string name, Input<string> id, ServiceExternalWikiState? state = null, CustomResourceOptions? options = null)
        {
