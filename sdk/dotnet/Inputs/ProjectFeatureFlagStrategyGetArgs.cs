...
namespace Pulumi.GitLab.Inputs
{
    ...
    public sealed class ProjectFeatureFlagStrategyGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("parameters")]
        public Input<Inputs.ProjectFeatureFlagStrategyParametersGetArgs>? Parameters { get; set; }

        [Input("scopes")]
        private InputList<Inputs.ProjectFeatureFlagStrategyScopeGetArgs>? _scopes;

        /// <summary>
        /// Scopes define which environments the strategy applies to.
        /// </summary>
        public InputList<Inputs.ProjectFeatureFlagStrategyScopeGetArgs> Scopes
        {
            get => _scopes ?? (_scopes = new InputList<Inputs.ProjectFeatureFlagStrategyScopeGetArgs>());
            set => _scopes = value;
        }
        ...
        public ProjectFeatureFlagStrategyGetArgs()
        {
        }
        public static new ProjectFeatureFlagStrategyGetArgs Empty => new ProjectFeatureFlagStrategyGetArgs();
    }
}
