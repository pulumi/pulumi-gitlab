...
namespace Pulumi.GitLab
{
    ...
    ///     });
    /// 
    ///     var mattermost = new GitLab.Index.ProjectIntegrationMattermost("mattermost", new()
    ///     {
    ...
    /// ## Import
    /// 
    /// Starting in Terraform v1.5.0, you can use an import block to import `gitlab.ProjectIntegrationMattermost`. For example:
    /// 
    ...
    /// ```
    /// </summary>
    [GitLabResourceType("gitlab:index/projectIntegrationMattermost:ProjectIntegrationMattermost")]
    public partial class ProjectIntegrationMattermost : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ProjectIntegrationMattermost(string name, ProjectIntegrationMattermostArgs args, CustomResourceOptions? options = null)
            : base("gitlab:index/projectIntegrationMattermost:ProjectIntegrationMattermost", name, args ?? new ProjectIntegrationMattermostArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProjectIntegrationMattermost(string name, Input<string> id, ProjectIntegrationMattermostState? state = null, CustomResourceOptions? options = null)
            : base("gitlab:index/projectIntegrationMattermost:ProjectIntegrationMattermost", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ProjectIntegrationMattermost Get(string name, Input<string> id, ProjectIntegrationMattermostState? state = null, CustomResourceOptions? options = null)
        {
            return new ProjectIntegrationMattermost(name, id, state, options);
        }
    }

    public sealed class ProjectIntegrationMattermostArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Branches to send notifications for. Valid options are "all", "default", "protected", and "default*and*protected".
        /// </summary>
        ...
        public ProjectIntegrationMattermostArgs()
        {
        }
        public static new ProjectIntegrationMattermostArgs Empty => new ProjectIntegrationMattermostArgs();
    }

    public sealed class ProjectIntegrationMattermostState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Branches to send notifications for. Valid options are "all", "default", "protected", and "default*and*protected".
        /// </summary>
        ...
        public ProjectIntegrationMattermostState()
        {
        }
        public static new ProjectIntegrationMattermostState Empty => new ProjectIntegrationMattermostState();
    }
}
