...
namespace Pulumi.GitLab
{
    ...
    ///     });
    /// 
    ///     var email = new GitLab.Index.ProjectIntegrationPipelinesEmail("email", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [GitLabResourceType("gitlab:index/projectIntegrationPipelinesEmail:ProjectIntegrationPipelinesEmail")]
    public partial class ProjectIntegrationPipelinesEmail : global::Pulumi.CustomResource
    {
        ...
        public ProjectIntegrationPipelinesEmail(string name, ProjectIntegrationPipelinesEmailArgs args, CustomResourceOptions? options = null)
            : base("gitlab:index/projectIntegrationPipelinesEmail:ProjectIntegrationPipelinesEmail", name, args ?? new ProjectIntegrationPipelinesEmailArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProjectIntegrationPipelinesEmail(string name, Input<string> id, ProjectIntegrationPipelinesEmailState? state = null, CustomResourceOptions? options = null)
            : base("gitlab:index/projectIntegrationPipelinesEmail:ProjectIntegrationPipelinesEmail", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ProjectIntegrationPipelinesEmail Get(string name, Input<string> id, ProjectIntegrationPipelinesEmailState? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class ProjectIntegrationPipelinesEmailArgs : global::Pulumi.ResourceArgs
    {
        ...
        public ProjectIntegrationPipelinesEmailArgs()
        {
        }
        public static new ProjectIntegrationPipelinesEmailArgs Empty => new ProjectIntegrationPipelinesEmailArgs();
    }
    ...
    public sealed class ProjectIntegrationPipelinesEmailState : global::Pulumi.ResourceArgs
    {
        ...
        public ProjectIntegrationPipelinesEmailState()
        {
        }
        public static new ProjectIntegrationPipelinesEmailState Empty => new ProjectIntegrationPipelinesEmailState();
    }
}
