...
namespace Pulumi.GitLab
{
    ...
    ///     });
    /// 
    ///     var tracker = new GitLab.Index.IntegrationCustomIssueTracker("tracker", new()
    ///     {
    ...
    /// 
    /// You can import a gitlab.IntegrationCustomIssueTracker state using the project ID, e.g.
    /// 
    /// ```sh
    ...
    public partial class IntegrationCustomIssueTracker : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public IntegrationCustomIssueTracker(string name, IntegrationCustomIssueTrackerArgs args, CustomResourceOptions? options = null)
            : base("gitlab:index/integrationCustomIssueTracker:IntegrationCustomIssueTracker", name, args ?? new IntegrationCustomIssueTrackerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationCustomIssueTracker(string name, Input<string> id, IntegrationCustomIssueTrackerState? state = null, CustomResourceOptions? options = null)
            : base("gitlab:index/integrationCustomIssueTracker:IntegrationCustomIssueTracker", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IntegrationCustomIssueTracker Get(string name, Input<string> id, IntegrationCustomIssueTrackerState? state = null, CustomResourceOptions? options = null)
        {
            return new IntegrationCustomIssueTracker(name, id, state, options);
        }
    }

    public sealed class IntegrationCustomIssueTrackerArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The URL to view an issue in the external issue tracker. Must contain :id.
        /// </summary>
        ...
        public IntegrationCustomIssueTrackerArgs()
        {
        }
        public static new IntegrationCustomIssueTrackerArgs Empty => new IntegrationCustomIssueTrackerArgs();
    }

    public sealed class IntegrationCustomIssueTrackerState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Whether the integration is active.
        /// </summary>
        ...
        public IntegrationCustomIssueTrackerState()
        {
        }
        public static new IntegrationCustomIssueTrackerState Empty => new IntegrationCustomIssueTrackerState();
    }
}
