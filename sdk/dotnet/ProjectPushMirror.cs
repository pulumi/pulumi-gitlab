...
namespace Pulumi.GitLab
{
    ...
    /// {
    ///     var foo = new GitLab.Index.ProjectPushMirror("foo", new()
    ///     {
    ///         Project = "1",
    ...
    /// ```
    /// </summary>
    [GitLabResourceType("gitlab:index/projectPushMirror:ProjectPushMirror")]
    public partial class ProjectPushMirror : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ProjectPushMirror(string name, ProjectPushMirrorArgs args, CustomResourceOptions? options = null)
            : base("gitlab:index/projectPushMirror:ProjectPushMirror", name, args ?? new ProjectPushMirrorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProjectPushMirror(string name, Input<string> id, ProjectPushMirrorState? state = null, CustomResourceOptions? options = null)
            : base("gitlab:index/projectPushMirror:ProjectPushMirror", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ProjectPushMirror Get(string name, Input<string> id, ProjectPushMirrorState? state = null, CustomResourceOptions? options = null)
        {
            return new ProjectPushMirror(name, id, state, options);
        }
    }

    public sealed class ProjectPushMirrorArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Determines the mirror authentication method. Valid values are: `SshPublicKey`, `Password`.
        /// </summary>
        ...
        public ProjectPushMirrorArgs()
        {
        }
        public static new ProjectPushMirrorArgs Empty => new ProjectPushMirrorArgs();
    }

    public sealed class ProjectPushMirrorState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Determines the mirror authentication method. Valid values are: `SshPublicKey`, `Password`.
        /// </summary>
        ...
        public ProjectPushMirrorState()
        {
        }
        public static new ProjectPushMirrorState Empty => new ProjectPushMirrorState();
    }
}
