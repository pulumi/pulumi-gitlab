...
namespace Pulumi.GitLab
{
    ...
    ///     });
    /// 
    ///     var @default = new GitLab.Index.ProjectIntegrationTelegram("default", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [GitLabResourceType("gitlab:index/projectIntegrationTelegram:ProjectIntegrationTelegram")]
    public partial class ProjectIntegrationTelegram : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ProjectIntegrationTelegram(string name, ProjectIntegrationTelegramArgs args, CustomResourceOptions? options = null)
            : base("gitlab:index/projectIntegrationTelegram:ProjectIntegrationTelegram", name, args ?? new ProjectIntegrationTelegramArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProjectIntegrationTelegram(string name, Input<string> id, ProjectIntegrationTelegramState? state = null, CustomResourceOptions? options = null)
            : base("gitlab:index/projectIntegrationTelegram:ProjectIntegrationTelegram", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ProjectIntegrationTelegram Get(string name, Input<string> id, ProjectIntegrationTelegramState? state = null, CustomResourceOptions? options = null)
        {
            return new ProjectIntegrationTelegram(name, id, state, options);
        }
    }

    public sealed class ProjectIntegrationTelegramArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Branches to send notifications for. Valid options are `All`, `Default`, `Protected`, `DefaultAndProtected`.
        /// </summary>
        ...
        public ProjectIntegrationTelegramArgs()
        {
        }
        public static new ProjectIntegrationTelegramArgs Empty => new ProjectIntegrationTelegramArgs();
    }

    public sealed class ProjectIntegrationTelegramState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Branches to send notifications for. Valid options are `All`, `Default`, `Protected`, `DefaultAndProtected`.
        /// </summary>
        ...
        public ProjectIntegrationTelegramState()
        {
        }
        public static new ProjectIntegrationTelegramState Empty => new ProjectIntegrationTelegramState();
    }
}
