...
class ProjectTagArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ref: Create tag using commit SHA, another tag name, or branch name. This attribute is not available for imported resources.
        :param pulumi.Input[builtins.str] message: The message of the annotated tag.
        :param pulumi.Input[builtins.str] name: The name of a tag.
        """
...
class _ProjectTagState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of a tag.
        :param pulumi.Input[builtins.str] project: The ID or URL-encoded path of the project owned by the authenticated user.
        :param pulumi.Input[builtins.bool] protected: Bool, true if tag has tag protection.
        :param pulumi.Input[builtins.str] ref: Create tag using commit SHA, another tag name, or branch name. This attribute is not available for imported resources.
        :param pulumi.Input[Sequence[pulumi.Input['ProjectTagReleaseArgs']]] releases: The release associated with the tag.
        :param pulumi.Input[builtins.str] target: The unique id assigned to the commit by Gitlab.
        """
...
class ProjectTag(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target: Optional[pulumi.Input[builtins.str]] = None) -> 'ProjectTag':
        """
