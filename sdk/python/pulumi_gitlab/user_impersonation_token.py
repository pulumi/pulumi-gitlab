...
class _UserImpersonationTokenState:
    def __init__(__self__, *,
                 ...
                 impersonation: pulumi.Input[Optional[_builtins.bool]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def impersonation(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def impersonation(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class UserImpersonationToken(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/user_tokens/#create-an-impersonation-token)
        ...
        Starting in Terraform v1.5.0, you can use an import block to import `UserImpersonationToken`. For example:
    ...
    def get(resource_name: str,
            ...
            token_id: pulumi.Input[Optional[_builtins.int]] = None,
            user_id: pulumi.Input[Optional[_builtins.int]] = None,
            validate_past_expiration_date: pulumi.Input[Optional[_builtins.bool]] = None) -> 'UserImpersonationToken':
        """
