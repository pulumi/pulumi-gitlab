...
class SystemHookArgs:
    def __init__(__self__, *,
                 ...
                 repository_update_events: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] url: The hook URL.
        :param pulumi.Input[builtins.bool] enable_ssl_verification: Do SSL verification when triggering the hook.
        :param pulumi.Input[builtins.bool] merge_requests_events: Trigger hook on merge requests events.
        :param pulumi.Input[builtins.bool] push_events: When true, the hook fires on push events.
        :param pulumi.Input[builtins.bool] repository_update_events: Trigger hook on repository update events.
        :param pulumi.Input[builtins.bool] tag_push_events: When true, the hook fires on new tags being pushed.
        :param pulumi.Input[builtins.str] token: Secret token to validate received payloads; this isn’t returned in the response. This attribute is not available for imported resources.
        """
    ...
    def repository_update_events(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def repository_update_events(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _SystemHookState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: The date and time the hook was created in ISO8601 format.
        :param pulumi.Input[builtins.bool] enable_ssl_verification: Do SSL verification when triggering the hook.
        :param pulumi.Input[builtins.bool] merge_requests_events: Trigger hook on merge requests events.
        :param pulumi.Input[builtins.bool] push_events: When true, the hook fires on push events.
        :param pulumi.Input[builtins.bool] repository_update_events: Trigger hook on repository update events.
...
class SystemHook(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tag_push_events: Optional[pulumi.Input[builtins.bool]] = None,
            token: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'SystemHook':
        """
    ...
    @property
    @pulumi.getter(name="enableSslVerification")
    def enable_ssl_verification(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Do SSL verification when triggering the hook.
        """
        return pulumi.get(self, "enable_ssl_verification")
    ...
    @property
    @pulumi.getter(name="repositoryUpdateEvents")
    def repository_update_events(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Trigger hook on repository update events.
        """
        return pulumi.get(self, "repository_update_events")
