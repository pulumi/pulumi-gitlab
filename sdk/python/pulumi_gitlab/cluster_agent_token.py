...
class ClusterAgentTokenArgs:
    def __init__(__self__, *,
                 agent_id: pulumi.Input[builtins.int],
        ...
        :param pulumi.Input[builtins.str] description: The Description for the agent.
    ...
    def agent_id(self) -> pulumi.Input[builtins.int]:
        """
        The ID of the agent.
        """
    ...
    @agent_id.setter
    def agent_id(self, value: pulumi.Input[builtins.int]):
...
class _ClusterAgentTokenState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The Description for the agent.
        :param pulumi.Input[builtins.str] last_used_at: The ISO8601 datetime when the token was last used.
        :param pulumi.Input[builtins.str] name: The Name of the agent.
        :param pulumi.Input[builtins.str] project: ID or full path of the project maintained by the authenticated user.
        :param pulumi.Input[builtins.str] status: The status of the token. Valid values are `active`, `revoked`.
        :param pulumi.Input[builtins.str] token: The secret token for the agent. The `token` is not available in imported resources.
        :param pulumi.Input[builtins.int] token_id: The ID of the token.
        """
...
class ClusterAgentToken(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            token: Optional[pulumi.Input[builtins.str]] = None,
            token_id: Optional[pulumi.Input[builtins.int]] = None) -> 'ClusterAgentToken':
        """
