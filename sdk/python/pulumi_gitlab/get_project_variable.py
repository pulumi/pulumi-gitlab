...
def get_project_variable(environment_scope: Optional[_builtins.str] = None,
...
def get_project_variable_output(environment_scope: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
