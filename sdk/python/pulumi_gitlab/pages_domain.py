...
class PagesDomainArgs:
    def __init__(__self__, *,
                 ...
                 auto_ssl_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] domain: The custom domain indicated by the user.
        :param pulumi.Input[builtins.str] project: The ID or [URL-encoded path of the project](https://docs.gitlab.com/api/index/#namespaced-path-encoding) owned by the authenticated user.
        :param pulumi.Input[builtins.bool] auto_ssl_enabled: Enables [automatic generation](https://docs.gitlab.com/user/project/pages/custom_domains_ssl_tls_certification/lets_encrypt_integration/) of SSL certificates issued by Let’s Encrypt for custom domains. When this is set to "true", certificate can't be provided.
        :param pulumi.Input[builtins.str] certificate: The certificate in PEM format with intermediates following in most specific to least specific order.
        :param pulumi.Input[builtins.bool] expired: Whether the certificate is expired.
        :param pulumi.Input[builtins.str] key: The certificate key in PEM format.
        """
    ...
    def auto_ssl_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_ssl_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _PagesDomainState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key: The certificate key in PEM format.
        :param pulumi.Input[builtins.str] project: The ID or [URL-encoded path of the project](https://docs.gitlab.com/api/index/#namespaced-path-encoding) owned by the authenticated user.
        :param pulumi.Input[builtins.str] url: The URL for the given domain.
        :param pulumi.Input[builtins.str] verification_code: The verification code for the domain.
        :param pulumi.Input[builtins.bool] verified: The certificate data.
        """
        if auto_ssl_enabled is not None:
            pulumi.set(__self__, "auto_ssl_enabled", auto_ssl_enabled)
        if certificate is not None:
...
class PagesDomain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            url: Optional[pulumi.Input[builtins.str]] = None,
            verification_code: Optional[pulumi.Input[builtins.str]] = None,
            verified: Optional[pulumi.Input[builtins.bool]] = None) -> 'PagesDomain':
        """
    ...
    @property
    @pulumi.getter(name="autoSslEnabled")
    def auto_ssl_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Enables [automatic generation](https://docs.gitlab.com/user/project/pages/custom_domains_ssl_tls_certification/lets_encrypt_integration/) of SSL certificates issued by Let’s Encrypt for custom domains. When this is set to "true", certificate can't be provided.
        """
        return pulumi.get(self, "auto_ssl_enabled")
