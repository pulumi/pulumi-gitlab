...
class ProjectIntegrationMicrosoftTeamsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] webhook: The Microsoft Teams webhook (Example, https://outlook.office.com/webhook/...). This value cannot be imported.
        :param pulumi.Input[builtins.str] branches_to_be_notified: Branches to send notifications for. Valid options are “all”, “default”, “protected”, and “default*and*protected”. The default value is “default”
        :param pulumi.Input[builtins.bool] confidential_issues_events: Enable notifications for confidential issue events
        :param pulumi.Input[builtins.bool] confidential_note_events: Enable notifications for confidential note events
        :param pulumi.Input[builtins.bool] issues_events: Enable notifications for issue events
...
class ProjectIntegrationMicrosoftTeams(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            webhook: Optional[pulumi.Input[builtins.str]] = None,
            wiki_page_events: Optional[pulumi.Input[builtins.bool]] = None) -> 'ProjectIntegrationMicrosoftTeams':
        """
    ...
    @property
    @pulumi.getter(name="confidentialIssuesEvents")
    def confidential_issues_events(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable notifications for confidential issue events
        """
        return pulumi.get(self, "confidential_issues_events")
    ...
    @property
    @pulumi.getter(name="confidentialNoteEvents")
    def confidential_note_events(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable notifications for confidential note events
        """
        return pulumi.get(self, "confidential_note_events")
    ...
    @property
    @pulumi.getter(name="issuesEvents")
    def issues_events(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable notifications for issue events
        """
        return pulumi.get(self, "issues_events")
    ...
    @property
    @pulumi.getter(name="mergeRequestsEvents")
    def merge_requests_events(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable notifications for merge request events
        """
        return pulumi.get(self, "merge_requests_events")
    ...
    @property
    @pulumi.getter(name="noteEvents")
    def note_events(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable notifications for note events
        """
        return pulumi.get(self, "note_events")
    ...
    @property
    @pulumi.getter(name="pipelineEvents")
    def pipeline_events(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable notifications for pipeline events
        """
        return pulumi.get(self, "pipeline_events")
    ...
    @property
    @pulumi.getter(name="wikiPageEvents")
    def wiki_page_events(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable notifications for wiki page events
        """
        return pulumi.get(self, "wiki_page_events")
