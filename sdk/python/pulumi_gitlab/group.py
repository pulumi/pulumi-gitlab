...
class GroupArgs:
    def __init__(__self__, *,
                 ...
                 allowed_email_domains_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 extra_shared_runners_minutes_limit: Optional[pulumi.Input[builtins.int]] = None,
                 ip_restriction_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 lfs_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 membership_lock: Optional[pulumi.Input[builtins.bool]] = None,
                 mentions_disabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 parent_id: Optional[pulumi.Input[builtins.int]] = None,
                 permanently_remove_on_delete: Optional[pulumi.Input[builtins.bool]] = None,
                 prevent_forking_outside_group: Optional[pulumi.Input[builtins.bool]] = None,
                 project_creation_level: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 share_with_group_lock: Optional[pulumi.Input[builtins.bool]] = None,
                 shared_runners_minutes_limit: Optional[pulumi.Input[builtins.int]] = None,
                 shared_runners_setting: Optional[pulumi.Input[builtins.str]] = None,
                 subgroup_creation_level: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] path: The path of the group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_email_domains_lists: A list of email address domains to allow group access. Will be concatenated together into a comma separated string.
        :param pulumi.Input[builtins.bool] auto_devops_enabled: Default to Auto DevOps pipeline for all projects within this group.
        ...
        :param pulumi.Input[builtins.str] default_branch: Initial default branch name.
        :param pulumi.Input[builtins.int] default_branch_protection: See https://docs.gitlab.com/api/groups/#options-for-default*branch*protection. Valid values are: `0`, `1`, `2`, `3`, `4`.
        ...
        :param pulumi.Input[builtins.int] extra_shared_runners_minutes_limit: Can be set by administrators only. Additional CI/CD minutes for this group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_restriction_ranges: A list of IP addresses or subnet masks to restrict group access. Will be concatenated together into a comma separated string. Only allowed on top level groups.
        :param pulumi.Input[builtins.bool] lfs_enabled: Enable/disable Large File Storage (LFS) for the projects in this group.
        :param pulumi.Input[builtins.bool] membership_lock: Users cannot be added to projects in this group.
        :param pulumi.Input[builtins.bool] mentions_disabled: Disable the capability of a group from getting mentioned.
        :param pulumi.Input[builtins.str] name: The name of the group.
        :param pulumi.Input[builtins.int] parent_id: Id of the parent group (creates a nested group).
        :param pulumi.Input[builtins.bool] permanently_remove_on_delete: Whether the group should be permanently removed during a `delete` operation. This only works with subgroups. Must be configured via an `apply` before the `destroy` is run.
        :param pulumi.Input[builtins.bool] prevent_forking_outside_group: Defaults to false. When enabled, users can not fork projects from this group to external namespaces.
        :param pulumi.Input[builtins.str] project_creation_level: Determine if developers can create projects in the group. Valid values are: `noone`, `owner`, `maintainer`, `developer`
        ...
        :param pulumi.Input[builtins.bool] require_two_factor_authentication: Require all users in this group to setup Two-factor authentication.
        :param pulumi.Input[builtins.bool] share_with_group_lock: Prevent sharing a project with another group within this group.
        :param pulumi.Input[builtins.int] shared_runners_minutes_limit: Can be set by administrators only. Maximum number of monthly CI/CD minutes for this group. Can be nil (default; inherit system default), 0 (unlimited), or > 0.
        :param pulumi.Input[builtins.str] shared_runners_setting: Enable or disable shared runners for a group’s subgroups and projects. Valid values are: `enabled`, `disabled_and_overridable`, `disabled_and_unoverridable`, `disabled_with_override`.
        :param pulumi.Input[builtins.str] subgroup_creation_level: Allowed to create subgroups. Valid values are: `owner`, `maintainer`.
        :param pulumi.Input[builtins.int] two_factor_grace_period: Defaults to 48. Time before Two-factor authentication is enforced (in hours).
        :param pulumi.Input[builtins.str] visibility_level: The group's visibility. Can be `private`, `internal`, or `public`. Valid values are: `private`, `internal`, `public`.
        :param pulumi.Input[builtins.str] wiki_access_level: The group's wiki access level. Only available on Premium and Ultimate plans. Valid values are `disabled`, `private`, `enabled`.
        """
    ...
    def allowed_email_domains_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def allowed_email_domains_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def extra_shared_runners_minutes_limit(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def extra_shared_runners_minutes_limit(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "extra_shared_runners_minutes_limit", value)

    @property
    @pulumi.getter(name="ipRestrictionRanges")
    def ip_restriction_ranges(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def ip_restriction_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def membership_lock(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def membership_lock(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "membership_lock", value)

    @property
    @pulumi.getter(name="mentionsDisabled")
    def mentions_disabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def mentions_disabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def permanently_remove_on_delete(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def permanently_remove_on_delete(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "permanently_remove_on_delete", value)

    @property
    @pulumi.getter(name="preventForkingOutsideGroup")
    def prevent_forking_outside_group(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def prevent_forking_outside_group(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "prevent_forking_outside_group", value)

    @property
    @pulumi.getter(name="projectCreationLevel")
    def project_creation_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def project_creation_level(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def share_with_group_lock(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def share_with_group_lock(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "share_with_group_lock", value)

    @property
    @pulumi.getter(name="sharedRunnersMinutesLimit")
    def shared_runners_minutes_limit(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def shared_runners_minutes_limit(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "shared_runners_minutes_limit", value)

    @property
    @pulumi.getter(name="sharedRunnersSetting")
    def shared_runners_setting(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def shared_runners_setting(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "shared_runners_setting", value)

    @property
    @pulumi.getter(name="subgroupCreationLevel")
    def subgroup_creation_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def subgroup_creation_level(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _GroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] emails_enabled: Enable email notifications.
        :param pulumi.Input[builtins.int] extra_shared_runners_minutes_limit: Can be set by administrators only. Additional CI/CD minutes for this group.
        :param pulumi.Input[builtins.str] full_name: The full name of the group.
        :param pulumi.Input[builtins.str] full_path: The full path of the group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_restriction_ranges: A list of IP addresses or subnet masks to restrict group access. Will be concatenated together into a comma separated string. Only allowed on top level groups.
        :param pulumi.Input[builtins.bool] lfs_enabled: Enable/disable Large File Storage (LFS) for the projects in this group.
        :param pulumi.Input[builtins.bool] membership_lock: Users cannot be added to projects in this group.
        :param pulumi.Input[builtins.bool] mentions_disabled: Disable the capability of a group from getting mentioned.
        ...
        :param pulumi.Input[builtins.bool] request_access_enabled: Allow users to request member access.
        :param pulumi.Input[builtins.bool] require_two_factor_authentication: Require all users in this group to setup Two-factor authentication.
        :param pulumi.Input[builtins.str] runners_token: The group level registration token to use during runner setup.
        :param pulumi.Input[builtins.bool] share_with_group_lock: Prevent sharing a project with another group within this group.
        :param pulumi.Input[builtins.int] shared_runners_minutes_limit: Can be set by administrators only. Maximum number of monthly CI/CD minutes for this group. Can be nil (default; inherit system default), 0 (unlimited), or > 0.
        :param pulumi.Input[builtins.str] shared_runners_setting: Enable or disable shared runners for a group’s subgroups and projects. Valid values are: `enabled`, `disabled_and_overridable`, `disabled_and_unoverridable`, `disabled_with_override`.
        :param pulumi.Input[builtins.str] subgroup_creation_level: Allowed to create subgroups. Valid values are: `owner`, `maintainer`.
        :param pulumi.Input[builtins.int] two_factor_grace_period: Defaults to 48. Time before Two-factor authentication is enforced (in hours).
        :param pulumi.Input[builtins.str] visibility_level: The group's visibility. Can be `private`, `internal`, or `public`. Valid values are: `private`, `internal`, `public`.
        :param pulumi.Input[builtins.str] web_url: Web URL of the group.
        :param pulumi.Input[builtins.str] wiki_access_level: The group's wiki access level. Only available on Premium and Ultimate plans. Valid values are `disabled`, `private`, `enabled`.
        """
        if allowed_email_domains_lists is not None:
            pulumi.set(__self__, "allowed_email_domains_lists", allowed_email_domains_lists)
...
class Group(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            visibility_level: Optional[pulumi.Input[builtins.str]] = None,
            web_url: Optional[pulumi.Input[builtins.str]] = None,
            wiki_access_level: Optional[pulumi.Input[builtins.str]] = None) -> 'Group':
        """
    ...
    @property
    @pulumi.getter(name="allowedEmailDomainsLists")
    def allowed_email_domains_lists(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of email address domains to allow group access. Will be concatenated together into a comma separated string.
        """
        return pulumi.get(self, "allowed_email_domains_lists")
    ...
    @property
    @pulumi.getter(name="extraSharedRunnersMinutesLimit")
    def extra_shared_runners_minutes_limit(self) -> pulumi.Output[builtins.int]:
        """
        Can be set by administrators only. Additional CI/CD minutes for this group.
        """
        return pulumi.get(self, "extra_shared_runners_minutes_limit")
    ...
    @property
    @pulumi.getter(name="ipRestrictionRanges")
    def ip_restriction_ranges(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of IP addresses or subnet masks to restrict group access. Will be concatenated together into a comma separated string. Only allowed on top level groups.
        """
        return pulumi.get(self, "ip_restriction_ranges")
    ...
    @property
    @pulumi.getter(name="mentionsDisabled")
    def mentions_disabled(self) -> pulumi.Output[builtins.bool]:
        """
        Disable the capability of a group from getting mentioned.
        """
        return pulumi.get(self, "mentions_disabled")
    ...
    @property
    @pulumi.getter(name="parentId")
    def parent_id(self) -> pulumi.Output[builtins.int]:
        """
        Id of the parent group (creates a nested group).
        """
        return pulumi.get(self, "parent_id")
    ...
    @property
    @pulumi.getter(name="permanentlyRemoveOnDelete")
    def permanently_remove_on_delete(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether the group should be permanently removed during a `delete` operation. This only works with subgroups. Must be configured via an `apply` before the `destroy` is run.
        """
        return pulumi.get(self, "permanently_remove_on_delete")
    ...
    @property
    @pulumi.getter(name="preventForkingOutsideGroup")
    def prevent_forking_outside_group(self) -> pulumi.Output[builtins.bool]:
        """
        Defaults to false. When enabled, users can not fork projects from this group to external namespaces.
        """
        return pulumi.get(self, "prevent_forking_outside_group")
    ...
    @property
    @pulumi.getter(name="projectCreationLevel")
    def project_creation_level(self) -> pulumi.Output[builtins.str]:
        """
        Determine if developers can create projects in the group. Valid values are: `noone`, `owner`, `maintainer`, `developer`
        """
        return pulumi.get(self, "project_creation_level")
    ...
    @property
    @pulumi.getter(name="shareWithGroupLock")
    def share_with_group_lock(self) -> pulumi.Output[builtins.bool]:
        """
        Prevent sharing a project with another group within this group.
        """
        return pulumi.get(self, "share_with_group_lock")
    ...
    @property
    @pulumi.getter(name="sharedRunnersMinutesLimit")
    def shared_runners_minutes_limit(self) -> pulumi.Output[builtins.int]:
        """
        Can be set by administrators only. Maximum number of monthly CI/CD minutes for this group. Can be nil (default; inherit system default), 0 (unlimited), or > 0.
        """
        return pulumi.get(self, "shared_runners_minutes_limit")
    ...
    @property
    @pulumi.getter(name="sharedRunnersSetting")
    def shared_runners_setting(self) -> pulumi.Output[builtins.str]:
        """
        Enable or disable shared runners for a group’s subgroups and projects. Valid values are: `enabled`, `disabled_and_overridable`, `disabled_and_unoverridable`, `disabled_with_override`.
        """
        return pulumi.get(self, "shared_runners_setting")
    ...
    @property
    @pulumi.getter(name="subgroupCreationLevel")
    def subgroup_creation_level(self) -> pulumi.Output[builtins.str]:
        """
        Allowed to create subgroups. Valid values are: `owner`, `maintainer`.
        """
        return pulumi.get(self, "subgroup_creation_level")
