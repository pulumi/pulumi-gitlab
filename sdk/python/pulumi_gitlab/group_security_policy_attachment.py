...
class GroupSecurityPolicyAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 policy_project: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a GroupSecurityPolicyAttachment resource.
        :param pulumi.Input[builtins.str] group: The ID or Full Path of the group which will have the security policy project assigned to it.
        :param pulumi.Input[builtins.str] policy_project: The ID or Full Path of the security policy project.
        """
    ...
    def policy_project(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def policy_project(self, value: pulumi.Input[builtins.str]):
...
class _GroupSecurityPolicyAttachmentState:
    def __init__(__self__, *,
                 ...
                 group_graphql_id: Optional[pulumi.Input[builtins.str]] = None,
                 policy_project: Optional[pulumi.Input[builtins.str]] = None,
                 policy_project_graphql_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering GroupSecurityPolicyAttachment resources.
        :param pulumi.Input[builtins.str] group: The ID or Full Path of the group which will have the security policy project assigned to it.
        :param pulumi.Input[builtins.str] group_graphql_id: The GraphQL ID of the group to which the security policty project will be attached.
        :param pulumi.Input[builtins.str] policy_project: The ID or Full Path of the security policy project.
        :param pulumi.Input[builtins.str] policy_project_graphql_id: The GraphQL ID of the security policy project.
        """
    ...
    def group_graphql_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def group_graphql_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "group_graphql_id", value)

    @property
    @pulumi.getter(name="policyProject")
    def policy_project(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID or Full Path of the security policy project.
        """
        return pulumi.get(self, "policy_project")
    ...
    @policy_project.setter
    def policy_project(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "policy_project", value)

    @property
    @pulumi.getter(name="policyProjectGraphqlId")
    def policy_project_graphql_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def policy_project_graphql_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "policy_project_graphql_id", value)


class GroupSecurityPolicyAttachment(pulumi.CustomResource):

    pulumi_type = "gitlab:index/groupSecurityPolicyAttachment:GroupSecurityPolicyAttachment"
    ...
    def get(resource_name: str,
            ...
            group_graphql_id: Optional[pulumi.Input[builtins.str]] = None,
            policy_project: Optional[pulumi.Input[builtins.str]] = None,
            policy_project_graphql_id: Optional[pulumi.Input[builtins.str]] = None) -> 'GroupSecurityPolicyAttachment':
        """
    ...
    @property
    @pulumi.getter(name="groupGraphqlId")
    def group_graphql_id(self) -> pulumi.Output[builtins.str]:
        """
        The GraphQL ID of the group to which the security policty project will be attached.
        """
        return pulumi.get(self, "group_graphql_id")
    ...
    @property
    @pulumi.getter(name="policyProject")
    def policy_project(self) -> pulumi.Output[builtins.str]:
        """
        The ID or Full Path of the security policy project.
        """
        return pulumi.get(self, "policy_project")
    ...
    @property
    @pulumi.getter(name="policyProjectGraphqlId")
    def policy_project_graphql_id(self) -> pulumi.Output[builtins.str]:
        """
        The GraphQL ID of the security policy project.
        """
        return pulumi.get(self, "policy_project_graphql_id")
