...
class ProjectHookArgs:
    def __init__(__self__, *,
                 ...
                 custom_headers: pulumi.Input[Optional[Sequence[pulumi.Input['ProjectHookCustomHeaderArgs']]]] = None,
    ...
    def custom_headers(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ProjectHookCustomHeaderArgs']]]]:
        """
    ...
    def custom_headers(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ProjectHookCustomHeaderArgs']]]]):
...
class ProjectHook(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/project_webhooks/)
        ...
        Starting in Terraform v1.5.0, you can use an import block to import `ProjectHook`. For example:
