...
class IntegrationJiraArgs:
    def __init__(__self__, *,
                 ...
                 comment_on_event_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 commit_events: Optional[pulumi.Input[builtins.bool]] = None,
                 issues_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 jira_auth_type: Optional[pulumi.Input[builtins.int]] = None,
                 jira_issue_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 jira_issue_regex: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] api_url: The base URL to the Jira instance API. Web URL value is used if not set. For example, https://jira-api.example.com.
        :param pulumi.Input[builtins.bool] comment_on_event_enabled: Enable comments inside Jira issues on each GitLab event (commit / merge request)
        :param pulumi.Input[builtins.bool] commit_events: Enable notifications for commit events
        :param pulumi.Input[builtins.bool] issues_enabled: Enable viewing Jira issues in GitLab.
        :param pulumi.Input[builtins.int] jira_auth_type: The authentication method to be used with Jira. 0 means Basic Authentication. 1 means Jira personal access token. Defaults to 0.
        :param pulumi.Input[builtins.str] jira_issue_prefix: Prefix to match Jira issue keys.
        ...
        :param pulumi.Input[builtins.str] project_key: The short identifier for your JIRA project, all uppercase, e.g., PROJ.
    ...
    def comment_on_event_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def comment_on_event_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "comment_on_event_enabled", value)

    @property
    @pulumi.getter(name="commitEvents")
    def commit_events(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def commit_events(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def jira_auth_type(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def jira_auth_type(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "jira_auth_type", value)

    @property
    @pulumi.getter(name="jiraIssuePrefix")
    def jira_issue_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def jira_issue_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "jira_issue_prefix", value)

    @property
    @pulumi.getter(name="jiraIssueRegex")
    def jira_issue_regex(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def jira_issue_regex(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "jira_issue_regex", value)

    @property
    @pulumi.getter(name="jiraIssueTransitionAutomatic")
    def jira_issue_transition_automatic(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "jira_issue_transition_automatic")

    @jira_issue_transition_automatic.setter
    def jira_issue_transition_automatic(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "jira_issue_transition_automatic", value)

    @property
    @pulumi.getter(name="jiraIssueTransitionId")
    def jira_issue_transition_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def jira_issue_transition_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @project_keys.setter
    def project_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class IntegrationJira(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            url: Optional[pulumi.Input[builtins.str]] = None,
            use_inherited_settings: Optional[pulumi.Input[builtins.bool]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'IntegrationJira':
        """
    ...
    @property
    @pulumi.getter(name="commentOnEventEnabled")
    def comment_on_event_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Enable comments inside Jira issues on each GitLab event (commit / merge request)
        """
        return pulumi.get(self, "comment_on_event_enabled")
    ...
    @property
    @pulumi.getter(name="commitEvents")
    def commit_events(self) -> pulumi.Output[builtins.bool]:
        """
        Enable notifications for commit events
        """
        return pulumi.get(self, "commit_events")
    ...
    @property
    @pulumi.getter(name="issuesEnabled")
    def issues_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable viewing Jira issues in GitLab.
        """
        return pulumi.get(self, "issues_enabled")
    ...
    @property
    @pulumi.getter(name="jiraAuthType")
    def jira_auth_type(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The authentication method to be used with Jira. 0 means Basic Authentication. 1 means Jira personal access token. Defaults to 0.
        """
        return pulumi.get(self, "jira_auth_type")
    ...
    @property
    @pulumi.getter(name="jiraIssuePrefix")
    def jira_issue_prefix(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Prefix to match Jira issue keys.
        """
        return pulumi.get(self, "jira_issue_prefix")
    ...
    @property
    @pulumi.getter(name="jiraIssueRegex")
    def jira_issue_regex(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Regular expression to match Jira issue keys.
        """
        return pulumi.get(self, "jira_issue_regex")
    ...
    @property
    @pulumi.getter(name="jiraIssueTransitionAutomatic")
    def jira_issue_transition_automatic(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "jira_issue_transition_automatic")

    @property
    @pulumi.getter(name="jiraIssueTransitionId")
    def jira_issue_transition_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of a transition that moves issues to a closed state. You can find this number under the JIRA workflow administration (Administration > Issues > Workflows) by selecting View under Operations of the desired workflow of your project. By default, this ID is set to 2.
        """
        return pulumi.get(self, "jira_issue_transition_id")
    ...
    @property
    @pulumi.getter(name="projectKeys")
    def project_keys(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Keys of Jira projects. When issues_enabled is true, this setting specifies which Jira projects to view issues from in GitLab.
        """
        return pulumi.get(self, "project_keys")
    ...
    @property
    @pulumi.getter(name="useInheritedSettings")
    def use_inherited_settings(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether or not to inherit default settings. Defaults to false.
        """
        return pulumi.get(self, "use_inherited_settings")
