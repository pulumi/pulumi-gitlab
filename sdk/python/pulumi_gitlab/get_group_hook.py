...
def get_group_hook(group: Optional[builtins.str] = None,
                   hook_id: Optional[builtins.int] = None,
...
def get_group_hook_output(group: Optional[pulumi.Input[builtins.str]] = None,
