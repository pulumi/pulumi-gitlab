...
class ProjectFreezePeriodArgs:
    def __init__(__self__, *,
                 freeze_end: pulumi.Input[builtins.str],
                 freeze_start: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] freeze_end: End of the Freeze Period in cron format (e.g. `0 2 * * *`).
        :param pulumi.Input[builtins.str] freeze_start: Start of the Freeze Period in cron format (e.g. `0 1 * * *`).
        :param pulumi.Input[builtins.str] project: The ID or URL-encoded path of the project to add the schedule to.
    ...
    def freeze_end(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @freeze_end.setter
    def freeze_end(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "freeze_end", value)

    @property
    @pulumi.getter(name="freezeStart")
    def freeze_start(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @freeze_start.setter
    def freeze_start(self, value: pulumi.Input[builtins.str]):
...
class _ProjectFreezePeriodState:
    def __init__(__self__, *,
                 cron_timezone: Optional[pulumi.Input[builtins.str]] = None,
                 freeze_end: Optional[pulumi.Input[builtins.str]] = None,
                 freeze_start: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="freezeEnd")
    def freeze_end(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        End of the Freeze Period in cron format (e.g. `0 2 * * *`).
        """
        return pulumi.get(self, "freeze_end")
    ...
    @freeze_end.setter
    def freeze_end(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "freeze_end", value)

    @property
    @pulumi.getter(name="freezeStart")
    def freeze_start(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Start of the Freeze Period in cron format (e.g. `0 1 * * *`).
        """
        return pulumi.get(self, "freeze_start")
    ...
    @freeze_start.setter
    def freeze_start(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "freeze_start", value)
...
class ProjectFreezePeriod(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            freeze_end: Optional[pulumi.Input[builtins.str]] = None,
            freeze_start: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None) -> 'ProjectFreezePeriod':
        """
    ...
    @property
    @pulumi.getter(name="cronTimezone")
    def cron_timezone(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The timezone.
        """
        return pulumi.get(self, "cron_timezone")
    ...
    @property
    @pulumi.getter(name="freezeEnd")
    def freeze_end(self) -> pulumi.Output[builtins.str]:
        """
        End of the Freeze Period in cron format (e.g. `0 2 * * *`).
        """
        return pulumi.get(self, "freeze_end")
    ...
    @property
    @pulumi.getter(name="freezeStart")
    def freeze_start(self) -> pulumi.Output[builtins.str]:
        """
        Start of the Freeze Period in cron format (e.g. `0 1 * * *`).
        """
        return pulumi.get(self, "freeze_start")
