...
class ProjectFreezePeriodArgs:
    ...
    @freeze_end.setter
    def freeze_end(self, value: pulumi.Input[_builtins.str]):
    ...
    @freeze_start.setter
    def freeze_start(self, value: pulumi.Input[_builtins.str]):
...
class ProjectFreezePeriod(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/freeze_periods/)
        ...
        Starting in Terraform v1.5.0, you can use an import block to import `ProjectFreezePeriod`. For example:
