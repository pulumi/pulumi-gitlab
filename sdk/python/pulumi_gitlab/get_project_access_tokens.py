...
def get_project_access_tokens(project: Optional[builtins.str] = None,
    ...
    **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/project_access_tokens/)
    ...
    :param builtins.str state: List all project access token that match the specified state. Valid values are `active`, `inactive`. Returns all project access token if not set.
    """
    __args__ = dict()
...
def get_project_access_tokens_output(project: Optional[pulumi.Input[builtins.str]] = None,
