...
def get_project_milestone(milestone_id: Optional[builtins.int] = None,
...
def get_project_milestone_output(milestone_id: Optional[pulumi.Input[builtins.int]] = None,
