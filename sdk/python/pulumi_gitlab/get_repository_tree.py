...
def get_repository_tree(path: Optional[builtins.str] = None,
    ...
    **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/repositories/#list-repository-tree)
    ...
    :param builtins.str path: The path inside repository. Used to get content of subdirectories.
    :param builtins.str project: The ID or full path of the project owned by the authenticated user.
    :param builtins.bool recursive: Boolean value used to get a recursive tree (false by default).
    :param builtins.str ref: The name of a repository branch or tag.
    """
    __args__ = dict()
    __args__['path'] = path
...
def get_repository_tree_output(path: Optional[pulumi.Input[Optional[builtins.str]]] = None,
