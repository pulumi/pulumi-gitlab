...
class ProjectComplianceFrameworkArgs:
    def __init__(__self__, *,
                 compliance_framework_id: pulumi.Input[builtins.str],
                 project: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a ProjectComplianceFramework resource.
        :param pulumi.Input[builtins.str] compliance_framework_id: Globally unique ID of the compliance framework to assign to the project.
        :param pulumi.Input[builtins.str] project: The ID or full path of the project to change the compliance framework of.
        """
    ...
    def compliance_framework_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def compliance_framework_id(self, value: pulumi.Input[builtins.str]):
...
class _ProjectComplianceFrameworkState:
    def __init__(__self__, *,
                 compliance_framework_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="complianceFrameworkId")
    def compliance_framework_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Globally unique ID of the compliance framework to assign to the project.
        """
        return pulumi.get(self, "compliance_framework_id")
    ...
    @compliance_framework_id.setter
    def compliance_framework_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "compliance_framework_id", value)
...
class ProjectComplianceFramework(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            compliance_framework_id: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None) -> 'ProjectComplianceFramework':
        """
    ...
    @property
    @pulumi.getter(name="complianceFrameworkId")
    def compliance_framework_id(self) -> pulumi.Output[builtins.str]:
        """
        Globally unique ID of the compliance framework to assign to the project.
        """
        return pulumi.get(self, "compliance_framework_id")
