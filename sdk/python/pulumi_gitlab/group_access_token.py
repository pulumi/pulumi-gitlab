...
class GroupAccessTokenArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] access_level: The access level for the group access token. Valid values are: `no one`, `minimal`, `guest`, `planner`, `reporter`, `security_manager`, `developer`, `maintainer`, `owner`. Default is `maintainer`.
    ...
    def access_level(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The access level for the group access token. Valid values are: `no one`, `minimal`, `guest`, `planner`, `reporter`, `security_manager`, `developer`, `maintainer`, `owner`. Default is `maintainer`.
        """
