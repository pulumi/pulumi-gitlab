...
__all__ = ['GroupIntegrationJiraArgs', 'GroupIntegrationJira']

@pulumi.input_type
class GroupIntegrationJiraArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] group: ID or full path of the group you want to activate integration on.
        ...
        :param pulumi.Input[_builtins.str] url: The URL to the JIRA project which is being linked to this GitLab group. For example, https://jira.example.com.
...
@pulumi.input_type
class _GroupIntegrationJiraState:
    def __init__(__self__, *,
...
@pulumi.type_token("gitlab:index/groupIntegrationJira:GroupIntegrationJira")
class GroupIntegrationJira(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/group_integrations/#jira)
        ...
        :param str resource_name: The name of the resource.
        :param GroupIntegrationJiraArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GroupIntegrationJiraArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GroupIntegrationJiraArgs.__new__(GroupIntegrationJiraArgs)
        ...
        super(GroupIntegrationJira, __self__).__init__(
            'gitlab:index/groupIntegrationJira:GroupIntegrationJira',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            url: pulumi.Input[Optional[_builtins.str]] = None,
            use_inherited_settings: pulumi.Input[Optional[_builtins.bool]] = None,
            username: pulumi.Input[Optional[_builtins.str]] = None) -> 'GroupIntegrationJira':
        """
        Get an existing GroupIntegrationJira resource's state with the given name, id, and optional extra
        ...
        __props__ = _GroupIntegrationJiraState.__new__(_GroupIntegrationJiraState)
        ...
        __props__.__dict__["use_inherited_settings"] = use_inherited_settings
        __props__.__dict__["username"] = username
        return GroupIntegrationJira(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="jiraIssuePrefix")
    def jira_issue_prefix(self) -> pulumi.Output[_builtins.str]:
        """
        Prefix to match Jira issue keys.
        """
        return pulumi.get(self, "jira_issue_prefix")
    ...
    @_builtins.property
    @pulumi.getter(name="jiraIssueRegex")
    def jira_issue_regex(self) -> pulumi.Output[_builtins.str]:
        """
        Regular expression to match Jira issue keys.
        """
        return pulumi.get(self, "jira_issue_regex")
    ...
    @_builtins.property
    @pulumi.getter(name="jiraIssueTransitionId")
    def jira_issue_transition_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of a transition that moves issues to a closed state. You can find this number under the JIRA workflow administration (Administration > Issues > Workflows) by selecting View under Operations of the desired workflow of your project. By default, this ID is set to 2.
        """
        return pulumi.get(self, "jira_issue_transition_id")
