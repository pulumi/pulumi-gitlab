...
def get_project_branches(project: Optional[builtins.str] = None,
    ...
    **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/branches/#list-repository-branches)
    ...
    :param builtins.str project: ID or URL-encoded path of the project owned by the authenticated user.
    """
    __args__ = dict()
...
def get_project_branches_output(project: Optional[pulumi.Input[builtins.str]] = None,
