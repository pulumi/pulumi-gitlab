...
class PersonalAccessTokenArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] scopes: The scope for the personal access token. It determines the actions which can be performed when authenticating with this
...
class _PersonalAccessTokenState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] scopes: The scope for the personal access token. It determines the actions which can be performed when authenticating with this
               token. Valid values are: `api`, `read_user`, `read_api`, `read_repository`, `write_repository`, `read_registry`,
               `write_registry`, `sudo`.
        :param pulumi.Input[str] token: The personal access token. This is only populated when creating a new personal access token. This attribute is not
