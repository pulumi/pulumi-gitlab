...
class IntegrationCustomIssueTracker(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/project_integrations/#custom-issue-tracker)
        ...
        You can import a IntegrationCustomIssueTracker state using the project ID, for example:
    ...
    def get(resource_name: str,
            ...
            project_url: pulumi.Input[Optional[_builtins.str]] = None,
            slug: pulumi.Input[Optional[_builtins.str]] = None,
            updated_at: pulumi.Input[Optional[_builtins.str]] = None) -> 'IntegrationCustomIssueTracker':
        """
