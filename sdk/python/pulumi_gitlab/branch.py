...
class BranchArgs:
    def __init__(__self__, *,
                 ...
                 keep_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] ref: The ref which the branch is created from.
    ...
    def keep_on_destroy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def keep_on_destroy(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _BranchState:
    def __init__(__self__, *,
                 ...
                 developer_can_merge: Optional[pulumi.Input[builtins.bool]] = None,
                 developer_can_push: Optional[pulumi.Input[builtins.bool]] = None,
                 keep_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 merged: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] can_push: Bool, true if you can push to the branch.
        :param pulumi.Input[Sequence[pulumi.Input['BranchCommitArgs']]] commits: The commit associated with the branch ref.
        :param pulumi.Input[builtins.bool] default: Bool, true if branch is the default branch for the project.
        ...
        :param pulumi.Input[builtins.str] ref: The ref which the branch is created from.
        :param pulumi.Input[builtins.str] web_url: The url of the created branch (https).
        """
    ...
    def developer_can_merge(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def developer_can_merge(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "developer_can_merge", value)

    @property
    @pulumi.getter(name="developerCanPush")
    def developer_can_push(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def developer_can_push(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @merged.setter
    def merged(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Branch(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            protected: Optional[pulumi.Input[builtins.bool]] = None,
            ref: Optional[pulumi.Input[builtins.str]] = None,
            web_url: Optional[pulumi.Input[builtins.str]] = None) -> 'Branch':
        """
    ...
    @property
    @pulumi.getter(name="canPush")
    def can_push(self) -> pulumi.Output[builtins.bool]:
        """
        Bool, true if you can push to the branch.
        """
        return pulumi.get(self, "can_push")
    ...
    @property
    @pulumi.getter(name="developerCanMerge")
    def developer_can_merge(self) -> pulumi.Output[builtins.bool]:
        """
        Bool, true if developer level access allows to merge branch.
        """
        return pulumi.get(self, "developer_can_merge")
    ...
    @property
    @pulumi.getter(name="developerCanPush")
    def developer_can_push(self) -> pulumi.Output[builtins.bool]:
        """
        Bool, true if developer level access allows git push.
        """
        return pulumi.get(self, "developer_can_push")
    ...
    @property
    @pulumi.getter(name="keepOnDestroy")
    def keep_on_destroy(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether the branch is kept once the resource destroyed (must be applied before a destroy).
        """
        return pulumi.get(self, "keep_on_destroy")
