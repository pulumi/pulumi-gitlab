...
class BranchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name for this branch.
        """
...
class _BranchState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] developer_can_merge: Bool, true if developer level access allows to merge branch.
        :param pulumi.Input[_builtins.bool] developer_can_push: Bool, true if developer level access allows git push.
        :param pulumi.Input[_builtins.bool] keep_on_destroy: Indicates whether the branch is kept once the resource destroyed (must be applied before a destroy).
        :param pulumi.Input[_builtins.bool] merged: Bool, true if the branch has been merged into its parent.
        :param pulumi.Input[_builtins.str] name: The name for this branch.
        :param pulumi.Input[_builtins.str] project: The ID or full path of the project which the branch is created against.
        :param pulumi.Input[_builtins.bool] protected: Bool, true if branch has branch protection.
        :param pulumi.Input[_builtins.str] ref: The ref which the branch is created from.
        :param pulumi.Input[_builtins.str] web_url: The url of the created branch (https).
        """
...
class Branch(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            can_push: pulumi.Input[Optional[_builtins.bool]] = None,
            commits: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BranchCommitArgs', 'BranchCommitArgsDict', 'outputs.BranchCommit']]]]] = None,
            default: pulumi.Input[Optional[_builtins.bool]] = None,
            developer_can_merge: pulumi.Input[Optional[_builtins.bool]] = None,
            developer_can_push: pulumi.Input[Optional[_builtins.bool]] = None,
            keep_on_destroy: pulumi.Input[Optional[_builtins.bool]] = None,
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[_builtins.bool] can_push: Bool, true if you can push to the branch.
        :param pulumi.Input[Sequence[pulumi.Input[Union['BranchCommitArgs', 'BranchCommitArgsDict', 'outputs.BranchCommit']]]] commits: The commit associated with the branch ref.
        :param pulumi.Input[_builtins.bool] default: Bool, true if branch is the default branch for the project.
        :param pulumi.Input[_builtins.bool] developer_can_merge: Bool, true if developer level access allows to merge branch.
        :param pulumi.Input[_builtins.bool] developer_can_push: Bool, true if developer level access allows git push.
        :param pulumi.Input[_builtins.bool] keep_on_destroy: Indicates whether the branch is kept once the resource destroyed (must be applied before a destroy).
    ...
    @_builtins.property
    @pulumi.getter(name="developerCanMerge")
    def developer_can_merge(self) -> pulumi.Output[_builtins.bool]:
        """
        Bool, true if developer level access allows to merge branch.
        """
        return pulumi.get(self, "developer_can_merge")
    ...
    @_builtins.property
    @pulumi.getter(name="developerCanPush")
    def developer_can_push(self) -> pulumi.Output[_builtins.bool]:
        """
        Bool, true if developer level access allows git push.
        """
        return pulumi.get(self, "developer_can_push")
    ...
    @_builtins.property
    @pulumi.getter
    def merged(self) -> pulumi.Output[_builtins.bool]:
        """
        Bool, true if the branch has been merged into its parent.
        """
        return pulumi.get(self, "merged")
