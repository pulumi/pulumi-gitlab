...
class GroupVariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] group: The name or id of the group.
        ...
        :param pulumi.Input[builtins.bool] masked: If set to `true`, the value of the variable will be masked in job logs. The value must meet the [masking requirements](https://docs.gitlab.com/ci/variables/#mask-a-cicd-variable).
...
@pulumi.type_token("gitlab:index/groupVariable:GroupVariable")
class GroupVariable(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            raw: Optional[pulumi.Input[builtins.bool]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None,
            variable_type: Optional[pulumi.Input[builtins.str]] = None) -> 'GroupVariable':
        """
