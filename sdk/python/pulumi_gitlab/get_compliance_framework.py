...
class GetComplianceFrameworkResult:
    ...
    def framework_id(self) -> _builtins.str:
        """
    ...
    def pipeline_configuration_full_path(self) -> _builtins.str:
        """
...
def get_compliance_framework(name: Optional[_builtins.str] = None,
    ...
    **Upstream API**: [GitLab GraphQL API docs](https://docs.gitlab.com/api/graphql/reference/#querynamespace)
    ...
    :param _builtins.str name: Name for the compliance framework.
    :param _builtins.str namespace_path: Full path of the namespace to where the compliance framework is.
    """
    __args__ = dict()
    __args__['name'] = name
