...
class IntegrationSlackArgs:
    def __init__(__self__, *,
                 ...
                 notify_only_default_branch: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] webhook: Webhook URL (Example, https://hooks.slack.com/services/...). This value cannot be imported.
        ...
        :param pulumi.Input[builtins.bool] notify_only_default_branch: This parameter has been replaced with `branches_to_be_notified`.
    ...
    def notify_only_default_branch(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def notify_only_default_branch(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _IntegrationSlackState:
    def __init__(__self__, *,
                 ...
                 issue_channel: Optional[pulumi.Input[builtins.str]] = None,
                 issues_events: Optional[pulumi.Input[builtins.bool]] = None,
                 job_events: Optional[pulumi.Input[builtins.bool]] = None,
                 merge_request_channel: Optional[pulumi.Input[builtins.str]] = None,
                 merge_requests_events: Optional[pulumi.Input[builtins.bool]] = None,
                 note_channel: Optional[pulumi.Input[builtins.str]] = None,
                 note_events: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] issue_channel: The name of the channel to receive issue events notifications.
        :param pulumi.Input[builtins.bool] issues_events: Enable notifications for issues events.
        :param pulumi.Input[builtins.bool] job_events: Enable notifications for job events. **ATTENTION**: This attribute is currently not being submitted to the GitLab API, due to https://gitlab.com/gitlab-org/api/client-go/issues/1354.
        :param pulumi.Input[builtins.str] merge_request_channel: The name of the channel to receive merge request events notifications.
        :param pulumi.Input[builtins.bool] merge_requests_events: Enable notifications for merge requests events.
        :param pulumi.Input[builtins.str] note_channel: The name of the channel to receive note events notifications.
        :param pulumi.Input[builtins.bool] note_events: Enable notifications for note events.
    ...
    def job_events(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @job_events.setter
    def job_events(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class IntegrationSlack(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            webhook: Optional[pulumi.Input[builtins.str]] = None,
            wiki_page_channel: Optional[pulumi.Input[builtins.str]] = None,
            wiki_page_events: Optional[pulumi.Input[builtins.bool]] = None) -> 'IntegrationSlack':
        """
    ...
    @property
    @pulumi.getter(name="confidentialNoteChannel")
    def confidential_note_channel(self) -> pulumi.Output[builtins.str]:
        """
        The name of the channel to receive confidential note events notifications.
        """
        return pulumi.get(self, "confidential_note_channel")
    ...
    @property
    @pulumi.getter(name="jobEvents")
    def job_events(self) -> pulumi.Output[builtins.bool]:
        """
        Enable notifications for job events. **ATTENTION**: This attribute is currently not being submitted to the GitLab API, due to https://gitlab.com/gitlab-org/api/client-go/issues/1354.
        """
        return pulumi.get(self, "job_events")
    ...
    @pulumi.getter(name="notifyOnlyDefaultBranch")
    @_utilities.deprecated("""use 'branches_to_be_notified' argument instead""")
    def notify_only_default_branch(self) -> pulumi.Output[builtins.bool]:
        """
        This parameter has been replaced with `branches_to_be_notified`.
        """
        return pulumi.get(self, "notify_only_default_branch")
