...
class ProjectLevelMrApprovalsArgs:
    def __init__(__self__, *,
                 ...
                 disable_overriding_approvers_per_merge_request: Optional[pulumi.Input[builtins.bool]] = None,
                 merge_requests_author_approval: Optional[pulumi.Input[builtins.bool]] = None,
                 merge_requests_disable_committers_approval: Optional[pulumi.Input[builtins.bool]] = None,
                 require_password_to_approve: Optional[pulumi.Input[builtins.bool]] = None,
                 reset_approvals_on_push: Optional[pulumi.Input[builtins.bool]] = None,
                 selective_code_owner_removals: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a ProjectLevelMrApprovals resource.
        :param pulumi.Input[builtins.str] project: The ID or URL-encoded path of a project to change MR approval configuration.
        :param pulumi.Input[builtins.bool] disable_overriding_approvers_per_merge_request: Set to `true` to disable overriding approvers per merge request.
        :param pulumi.Input[builtins.bool] merge_requests_author_approval: Set to `true` to allow merge requests authors to approve their own merge requests.
        :param pulumi.Input[builtins.bool] merge_requests_disable_committers_approval: Set to `true` to disable merge request committers from approving their own merge requests.
        :param pulumi.Input[builtins.bool] require_password_to_approve: Set to `true` to require authentication to approve merge requests.
        :param pulumi.Input[builtins.bool] reset_approvals_on_push: Set to `true` to remove all approvals in a merge request when new commits are pushed to its source branch. Default is `true`.
        :param pulumi.Input[builtins.bool] selective_code_owner_removals: Reset approvals from Code Owners if their files changed. Can be enabled only if reset*approvals*on_push is disabled.
        """
    ...
    def disable_overriding_approvers_per_merge_request(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def disable_overriding_approvers_per_merge_request(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "disable_overriding_approvers_per_merge_request", value)

    @property
    @pulumi.getter(name="mergeRequestsAuthorApproval")
    def merge_requests_author_approval(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def merge_requests_author_approval(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "merge_requests_author_approval", value)

    @property
    @pulumi.getter(name="mergeRequestsDisableCommittersApproval")
    def merge_requests_disable_committers_approval(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def merge_requests_disable_committers_approval(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "merge_requests_disable_committers_approval", value)

    @property
    @pulumi.getter(name="requirePasswordToApprove")
    def require_password_to_approve(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def require_password_to_approve(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "require_password_to_approve", value)

    @property
    @pulumi.getter(name="resetApprovalsOnPush")
    def reset_approvals_on_push(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def reset_approvals_on_push(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "reset_approvals_on_push", value)

    @property
    @pulumi.getter(name="selectiveCodeOwnerRemovals")
    def selective_code_owner_removals(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def selective_code_owner_removals(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ProjectLevelMrApprovals(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            require_password_to_approve: Optional[pulumi.Input[builtins.bool]] = None,
            reset_approvals_on_push: Optional[pulumi.Input[builtins.bool]] = None,
            selective_code_owner_removals: Optional[pulumi.Input[builtins.bool]] = None) -> 'ProjectLevelMrApprovals':
        """
    ...
    @property
    @pulumi.getter(name="disableOverridingApproversPerMergeRequest")
    def disable_overriding_approvers_per_merge_request(self) -> pulumi.Output[builtins.bool]:
        """
        Set to `true` to disable overriding approvers per merge request.
        """
        return pulumi.get(self, "disable_overriding_approvers_per_merge_request")
    ...
    @property
    @pulumi.getter(name="mergeRequestsAuthorApproval")
    def merge_requests_author_approval(self) -> pulumi.Output[builtins.bool]:
        """
        Set to `true` to allow merge requests authors to approve their own merge requests.
        """
        return pulumi.get(self, "merge_requests_author_approval")
    ...
    @property
    @pulumi.getter(name="mergeRequestsDisableCommittersApproval")
    def merge_requests_disable_committers_approval(self) -> pulumi.Output[builtins.bool]:
        """
        Set to `true` to disable merge request committers from approving their own merge requests.
        """
        return pulumi.get(self, "merge_requests_disable_committers_approval")
    ...
    @property
    @pulumi.getter(name="requirePasswordToApprove")
    def require_password_to_approve(self) -> pulumi.Output[builtins.bool]:
        """
        Set to `true` to require authentication to approve merge requests.
        """
        return pulumi.get(self, "require_password_to_approve")
    ...
    @property
    @pulumi.getter(name="resetApprovalsOnPush")
    def reset_approvals_on_push(self) -> pulumi.Output[builtins.bool]:
        """
        Set to `true` to remove all approvals in a merge request when new commits are pushed to its source branch. Default is `true`.
        """
        return pulumi.get(self, "reset_approvals_on_push")
    ...
    @property
    @pulumi.getter(name="selectiveCodeOwnerRemovals")
    def selective_code_owner_removals(self) -> pulumi.Output[builtins.bool]:
        """
        Reset approvals from Code Owners if their files changed. Can be enabled only if reset*approvals*on_push is disabled.
        """
        return pulumi.get(self, "selective_code_owner_removals")
