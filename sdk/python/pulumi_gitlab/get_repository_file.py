...
class GetRepositoryFileResult:
    ...
    def execute_filemode(self) -> _builtins.bool:
        """
    ...
    def last_commit_id(self) -> _builtins.str:
        """
...
def get_repository_file(file_path: Optional[_builtins.str] = None,
    ...
    **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/repository_files/)
    ...
    :param _builtins.str file_path: The full path of the file. It must be relative to the root of the project without a leading slash `/` or `./`.
    :param _builtins.str project: The name or ID of the project.
    :param _builtins.str ref: The name of branch, tag or commit.
    """
    __args__ = dict()
