...
class GroupMembershipArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] access_level: Access level for the member. Valid values are: `no one`, `minimal`, `guest`, `planner`, `reporter`, `security_manager`, `developer`, `maintainer`, `owner`.
    ...
    def access_level(self) -> pulumi.Input[_builtins.str]:
        """
        Access level for the member. Valid values are: `no one`, `minimal`, `guest`, `planner`, `reporter`, `security_manager`, `developer`, `maintainer`, `owner`.
        """
...
class GroupMembership(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="skipSubresourcesOnDestroy")
    def skip_subresources_on_destroy(self) -> pulumi.Output[_builtins.bool]:
        """
        Whether the deletion of direct memberships of the removed member in subgroups and projects should be skipped. Only used during a destroy.
        """
        return pulumi.get(self, "skip_subresources_on_destroy")
    ...
    @_builtins.property
    @pulumi.getter(name="unassignIssuablesOnDestroy")
    def unassign_issuables_on_destroy(self) -> pulumi.Output[_builtins.bool]:
        """
        Whether the removed member should be unassigned from any issues or merge requests inside a given group or project. Only used during a destroy.
        """
        return pulumi.get(self, "unassign_issuables_on_destroy")
