...
class ProjectDeployToken(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/deploy_tokens/#project-deploy-tokens)
        ...
        Starting in Terraform v1.5.0, you can use an import block to import `ProjectDeployToken`. For example:
    ...
    def get(resource_name: str,
            ...
            token: pulumi.Input[Optional[_builtins.str]] = None,
            username: pulumi.Input[Optional[_builtins.str]] = None,
            validate_past_expiration_date: pulumi.Input[Optional[_builtins.bool]] = None) -> 'ProjectDeployToken':
        """
