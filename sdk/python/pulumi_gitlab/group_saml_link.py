...
class GroupSamlLinkArgs:
    def __init__(__self__, *,
                 ...
                 saml_group_name: pulumi.Input[builtins.str],
                 member_role_id: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a GroupSamlLink resource.
        :param pulumi.Input[builtins.str] access_level: Access level for members of the SAML group. Valid values are: `guest`, `planner`, `reporter`, `developer`, `maintainer`, `owner`.
        :param pulumi.Input[builtins.str] group: The ID or path of the group to add the SAML Group Link to.
        :param pulumi.Input[builtins.str] saml_group_name: The name of the SAML group.
        :param pulumi.Input[builtins.int] member_role_id: The ID of a custom member role. Only available for Ultimate instances. When using a custom role, the `access_level` must match the base role used to create the custom role.
        """
    ...
    def saml_group_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def saml_group_name(self, value: pulumi.Input[builtins.str]):
    ...
    def member_role_id(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _GroupSamlLinkState:
    def __init__(__self__, *,
                 ...
                 member_role_id: Optional[pulumi.Input[builtins.int]] = None,
                 saml_group_name: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="samlGroupName")
    def saml_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the SAML group.
        """
        return pulumi.get(self, "saml_group_name")
    ...
    @saml_group_name.setter
    def saml_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "saml_group_name", value)


@pulumi.type_token("gitlab:index/groupSamlLink:GroupSamlLink")
class GroupSamlLink(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            group: Optional[pulumi.Input[builtins.str]] = None,
            member_role_id: Optional[pulumi.Input[builtins.int]] = None,
            saml_group_name: Optional[pulumi.Input[builtins.str]] = None) -> 'GroupSamlLink':
        """
    ...
    @property
    @pulumi.getter(name="samlGroupName")
    def saml_group_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the SAML group.
        """
        return pulumi.get(self, "saml_group_name")
