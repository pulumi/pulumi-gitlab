...
class GroupSamlLinkArgs:
    ...
    def saml_group_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def saml_group_name(self, value: pulumi.Input[_builtins.str]):
...
class GroupSamlLink(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/saml/#saml-group-links)
        ...
        Starting in Terraform v1.5.0, you can use an import block to import `GroupSamlLink`. For example:
    ...
    @_builtins.property
    @pulumi.getter(name="samlGroupName")
    def saml_group_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the SAML group.
        """
        return pulumi.get(self, "saml_group_name")
