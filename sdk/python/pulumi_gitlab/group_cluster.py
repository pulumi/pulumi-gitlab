...
class GroupCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/group_clusters/)
        ...
        Starting in Terraform v1.5.0, you can use an import block to import `GroupCluster`. For example:
    ...
    def get(resource_name: str,
            ...
            name: pulumi.Input[Optional[_builtins.str]] = None,
            platform_type: pulumi.Input[Optional[_builtins.str]] = None,
            provider_type: pulumi.Input[Optional[_builtins.str]] = None) -> 'GroupCluster':
        """
