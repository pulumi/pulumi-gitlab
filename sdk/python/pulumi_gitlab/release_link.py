...
class ReleaseLinkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] project: The ID or [URL-encoded path of the project](https://docs.gitlab.com/api/index/#namespaced-path-encoding).
        :param pulumi.Input[builtins.str] tag_name: The tag associated with the Release.
        :param pulumi.Input[builtins.str] url: The URL of the link. Link URLs must be unique within the release.
        :param pulumi.Input[builtins.str] filepath: Relative path for a [Direct Asset link](https://docs.gitlab.com/user/project/releases/index/#permanent-links-to-release-assets).
        :param pulumi.Input[builtins.str] link_type: The type of the link. Valid values are `other`, `runbook`, `image`, `package`. Defaults to other.
        :param pulumi.Input[builtins.str] name: The name of the link. Link names must be unique within the release.
        """
...
class _ReleaseLinkState:
    def __init__(__self__, *,
                 direct_asset_url: Optional[pulumi.Input[builtins.str]] = None,
                 external: Optional[pulumi.Input[builtins.bool]] = None,
                 filepath: Optional[pulumi.Input[builtins.str]] = None,
                 link_id: Optional[pulumi.Input[builtins.int]] = None,
                 link_type: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] direct_asset_url: Full path for a [Direct Asset link](https://docs.gitlab.com/user/project/releases/index/#permanent-links-to-release-assets).
        :param pulumi.Input[builtins.bool] external: External or internal link.
        :param pulumi.Input[builtins.str] filepath: Relative path for a [Direct Asset link](https://docs.gitlab.com/user/project/releases/index/#permanent-links-to-release-assets).
        :param pulumi.Input[builtins.int] link_id: The ID of the link.
        :param pulumi.Input[builtins.str] link_type: The type of the link. Valid values are `other`, `runbook`, `image`, `package`. Defaults to other.
        :param pulumi.Input[builtins.str] name: The name of the link. Link names must be unique within the release.
        :param pulumi.Input[builtins.str] project: The ID or [URL-encoded path of the project](https://docs.gitlab.com/api/index/#namespaced-path-encoding).
        :param pulumi.Input[builtins.str] tag_name: The tag associated with the Release.
    ...
    def direct_asset_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def direct_asset_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def link_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The ID of the link.
        """
    ...
    @link_id.setter
    def link_id(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ReleaseLink(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            tag_name: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'ReleaseLink':
        """
    ...
    @property
    @pulumi.getter(name="directAssetUrl")
    def direct_asset_url(self) -> pulumi.Output[builtins.str]:
        """
        Full path for a [Direct Asset link](https://docs.gitlab.com/user/project/releases/index/#permanent-links-to-release-assets).
        """
        return pulumi.get(self, "direct_asset_url")
    ...
    @property
    @pulumi.getter
    def filepath(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Relative path for a [Direct Asset link](https://docs.gitlab.com/user/project/releases/index/#permanent-links-to-release-assets).
        """
        return pulumi.get(self, "filepath")
    ...
    @property
    @pulumi.getter(name="linkId")
    def link_id(self) -> pulumi.Output[builtins.int]:
        """
        The ID of the link.
        """
        return pulumi.get(self, "link_id")
    ...
    @property
    @pulumi.getter(name="linkType")
    def link_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The type of the link. Valid values are `other`, `runbook`, `image`, `package`. Defaults to other.
        """
        return pulumi.get(self, "link_type")
