...
class MemberRoleArgs:
    def __init__(__self__, *,
                 base_access_level: pulumi.Input[builtins.str],
                 enabled_permissions: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 group_path: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] group_path: Full path of the namespace to create the member role in. **Required for SAAS** **Not allowed for self-managed**
        :param pulumi.Input[builtins.str] name: Name for the member role.
        """
    ...
    def base_access_level(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def base_access_level(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "base_access_level", value)

    @property
    @pulumi.getter(name="enabledPermissions")
    def enabled_permissions(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def enabled_permissions(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def group_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @group_path.setter
    def group_path(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _MemberRoleState:
    def __init__(__self__, *,
                 base_access_level: Optional[pulumi.Input[builtins.str]] = None,
                 created_at: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 edit_path: Optional[pulumi.Input[builtins.str]] = None,
                 enabled_permissions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 group_path: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] enabled_permissions: All permissions enabled for the custom role. Valid values are: `ADMIN_CICD_VARIABLES`, `ADMIN_COMPLIANCE_FRAMEWORK`, `ADMIN_GROUP_MEMBER`, `ADMIN_INTEGRATIONS`, `ADMIN_MERGE_REQUEST`, `ADMIN_PROTECTED_BRANCH`, `ADMIN_PUSH_RULES`, `ADMIN_RUNNERS`, `ADMIN_TERRAFORM_STATE`, `ADMIN_VULNERABILITY`, `ADMIN_WEB_HOOK`, `ARCHIVE_PROJECT`, `MANAGE_DEPLOY_TOKENS`, `MANAGE_GROUP_ACCESS_TOKENS`, `MANAGE_MERGE_REQUEST_SETTINGS`, `MANAGE_PROJECT_ACCESS_TOKENS`, `MANAGE_SECURITY_POLICY_LINK`, `READ_ADMIN_CICD`, `READ_ADMIN_DASHBOARD`, `READ_CODE`, `READ_COMPLIANCE_DASHBOARD`, `READ_CRM_CONTACT`, `READ_DEPENDENCY`, `READ_RUNNERS`, `READ_VULNERABILITY`, `REMOVE_GROUP`, `REMOVE_PROJECT`
        :param pulumi.Input[builtins.str] group_path: Full path of the namespace to create the member role in. **Required for SAAS** **Not allowed for self-managed**
        :param pulumi.Input[builtins.int] iid: The id integer value extracted from the `id` attribute
        :param pulumi.Input[builtins.str] name: Name for the member role.
        """
    ...
    @property
    @pulumi.getter(name="baseAccessLevel")
    def base_access_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The base access level for the custom role. Valid values are: `DEVELOPER`, `GUEST`, `MAINTAINER`, `MINIMAL_ACCESS`, `OWNER`, `REPORTER`
        """
        return pulumi.get(self, "base_access_level")
    ...
    @base_access_level.setter
    def base_access_level(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "base_access_level", value)
    ...
    def edit_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @edit_path.setter
    def edit_path(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "edit_path", value)

    @property
    @pulumi.getter(name="enabledPermissions")
    def enabled_permissions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        All permissions enabled for the custom role. Valid values are: `ADMIN_CICD_VARIABLES`, `ADMIN_COMPLIANCE_FRAMEWORK`, `ADMIN_GROUP_MEMBER`, `ADMIN_INTEGRATIONS`, `ADMIN_MERGE_REQUEST`, `ADMIN_PROTECTED_BRANCH`, `ADMIN_PUSH_RULES`, `ADMIN_RUNNERS`, `ADMIN_TERRAFORM_STATE`, `ADMIN_VULNERABILITY`, `ADMIN_WEB_HOOK`, `ARCHIVE_PROJECT`, `MANAGE_DEPLOY_TOKENS`, `MANAGE_GROUP_ACCESS_TOKENS`, `MANAGE_MERGE_REQUEST_SETTINGS`, `MANAGE_PROJECT_ACCESS_TOKENS`, `MANAGE_SECURITY_POLICY_LINK`, `READ_ADMIN_CICD`, `READ_ADMIN_DASHBOARD`, `READ_CODE`, `READ_COMPLIANCE_DASHBOARD`, `READ_CRM_CONTACT`, `READ_DEPENDENCY`, `READ_RUNNERS`, `READ_VULNERABILITY`, `REMOVE_GROUP`, `REMOVE_PROJECT`
        """
        return pulumi.get(self, "enabled_permissions")
    ...
    @enabled_permissions.setter
    def enabled_permissions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "enabled_permissions", value)
...
class MemberRole(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            group_path: Optional[pulumi.Input[builtins.str]] = None,
            iid: Optional[pulumi.Input[builtins.int]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'MemberRole':
        """
    ...
    @property
    @pulumi.getter(name="baseAccessLevel")
    def base_access_level(self) -> pulumi.Output[builtins.str]:
        """
        The base access level for the custom role. Valid values are: `DEVELOPER`, `GUEST`, `MAINTAINER`, `MINIMAL_ACCESS`, `OWNER`, `REPORTER`
        """
        return pulumi.get(self, "base_access_level")
    ...
    @property
    @pulumi.getter(name="editPath")
    def edit_path(self) -> pulumi.Output[builtins.str]:
        """
        The Web UI path to edit the member role
        """
        return pulumi.get(self, "edit_path")
    ...
    @property
    @pulumi.getter(name="enabledPermissions")
    def enabled_permissions(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        All permissions enabled for the custom role. Valid values are: `ADMIN_CICD_VARIABLES`, `ADMIN_COMPLIANCE_FRAMEWORK`, `ADMIN_GROUP_MEMBER`, `ADMIN_INTEGRATIONS`, `ADMIN_MERGE_REQUEST`, `ADMIN_PROTECTED_BRANCH`, `ADMIN_PUSH_RULES`, `ADMIN_RUNNERS`, `ADMIN_TERRAFORM_STATE`, `ADMIN_VULNERABILITY`, `ADMIN_WEB_HOOK`, `ARCHIVE_PROJECT`, `MANAGE_DEPLOY_TOKENS`, `MANAGE_GROUP_ACCESS_TOKENS`, `MANAGE_MERGE_REQUEST_SETTINGS`, `MANAGE_PROJECT_ACCESS_TOKENS`, `MANAGE_SECURITY_POLICY_LINK`, `READ_ADMIN_CICD`, `READ_ADMIN_DASHBOARD`, `READ_CODE`, `READ_COMPLIANCE_DASHBOARD`, `READ_CRM_CONTACT`, `READ_DEPENDENCY`, `READ_RUNNERS`, `READ_VULNERABILITY`, `REMOVE_GROUP`, `REMOVE_PROJECT`
        """
        return pulumi.get(self, "enabled_permissions")
    ...
    @property
    @pulumi.getter(name="groupPath")
    def group_path(self) -> pulumi.Output[builtins.str]:
        """
        Full path of the namespace to create the member role in. **Required for SAAS** **Not allowed for self-managed**
        """
        return pulumi.get(self, "group_path")
