...
class ProjectVariable(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/project_level_variables/)
        ...
        Starting in Terraform v1.5.0, you can use an import block to import `ProjectVariable`. For example:
    ...
    def get(resource_name: str,
            ...
            raw: Optional[pulumi.Input[_builtins.bool]] = None,
            value: Optional[pulumi.Input[_builtins.str]] = None,
            variable_type: Optional[pulumi.Input[_builtins.str]] = None) -> 'ProjectVariable':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="environmentScope")
    def environment_scope(self) -> pulumi.Output[_builtins.str]:
        """
        The environment scope of the variable. Defaults to all environment (`*`). Note that in Community Editions of Gitlab, values other than `*` will cause inconsistent plans.
        """
        return pulumi.get(self, "environment_scope")
