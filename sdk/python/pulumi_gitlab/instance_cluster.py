...
class InstanceClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] kubernetes_token: The token to authenticate against Kubernetes. This attribute cannot be read.
        ...
        :param pulumi.Input[_builtins.str] kubernetes_namespace: The unique namespace related to the instance.
...
class InstanceCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/instance_clusters/)
        ...
        Starting in Terraform v1.5.0, you can use an import block to import `InstanceCluster`. For example:
