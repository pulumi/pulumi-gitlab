...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] note: The note associated to the user.
        :param pulumi.Input[_builtins.str] password: The password of the user.
        :param pulumi.Input[_builtins.int] projects_limit: Integer, defaults to 0.  Number of projects user can create.
        :param pulumi.Input[_builtins.bool] reset_password: Boolean, defaults to false. Send user password reset link.
        :param pulumi.Input[_builtins.bool] skip_confirmation: Boolean, defaults to true. Whether to skip confirmation.
        :param pulumi.Input[_builtins.str] state: String, defaults to 'active'. The state of the user account. Valid values are `active`, `deactivated`, `blocked`.
        """
...
class User(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="canCreateGroup")
    def can_create_group(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Boolean, defaults to false. Whether to allow the user to create groups.
        """
        return pulumi.get(self, "can_create_group")
    ...
    @_builtins.property
    @pulumi.getter(name="forceRandomPassword")
    def force_random_password(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Set user password to a random value
        """
        return pulumi.get(self, "force_random_password")
    ...
    @_builtins.property
    @pulumi.getter(name="isExternal")
    def is_external(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Boolean, defaults to false. Whether a user has access only to some internal or private projects. External users can only access projects to which they are explicitly granted access.
        """
        return pulumi.get(self, "is_external")
    ...
    @_builtins.property
    @pulumi.getter(name="projectsLimit")
    def projects_limit(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Integer, defaults to 0.  Number of projects user can create.
        """
        return pulumi.get(self, "projects_limit")
    ...
    @_builtins.property
    @pulumi.getter(name="resetPassword")
    def reset_password(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Boolean, defaults to false. Send user password reset link.
        """
        return pulumi.get(self, "reset_password")
    ...
    @_builtins.property
    @pulumi.getter(name="skipConfirmation")
    def skip_confirmation(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Boolean, defaults to true. Whether to skip confirmation.
        """
        return pulumi.get(self, "skip_confirmation")
