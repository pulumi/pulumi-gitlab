...
def get_instance_deploy_keys(public: Optional[_builtins.bool] = None,
    ...
    **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/deploy_keys/#list-all-deploy-keys)
    ...
    :param _builtins.bool public: Only return deploy keys that are public.
    """
    __args__ = dict()
...
def get_instance_deploy_keys_output(public: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
