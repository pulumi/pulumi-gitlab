...
class LabelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] project: The name or id of the project to add the label to.
...
class Label(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            label_id: Optional[pulumi.Input[builtins.int]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None) -> 'Label':
        """
    ...
    @property
    @pulumi.getter(name="labelId")
    def label_id(self) -> pulumi.Output[builtins.int]:
        """
        The id of the project label.
        """
        return pulumi.get(self, "label_id")
