...
def get_user_sshkeys(user_id: Optional[_builtins.int] = None,
    ...
    **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/user_keys/#list-all-ssh-keys-for-a-user)
    ...
    :param _builtins.int user_id: ID of the user to get the SSH keys for.
    :param _builtins.str username: Username of the user to get the SSH keys for.
    """
    __args__ = dict()
