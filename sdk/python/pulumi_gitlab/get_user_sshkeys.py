...
def get_user_sshkeys(user_id: Optional[builtins.int] = None,
    ...
    **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/users/#list-ssh-keys-for-user)
    ...
    :param builtins.str username: Username of the user to get the SSH keys for.
    """
    __args__ = dict()
...
def get_user_sshkeys_output(user_id: Optional[pulumi.Input[Optional[builtins.int]]] = None,
