...
class GroupBadgeArgs:
    def __init__(__self__, *,
                 ...
                 link_url: pulumi.Input[builtins.str],
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a GroupBadge resource.
        :param pulumi.Input[builtins.str] group: The ID or URL-encoded path of the group to add the badge to.
        :param pulumi.Input[builtins.str] image_url: The image url which will be presented on group overview.
        :param pulumi.Input[builtins.str] link_url: The url linked with the badge.
        :param pulumi.Input[builtins.str] name: The name of the badge.
        """
    ...
    def link_url(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @link_url.setter
    def link_url(self, value: pulumi.Input[builtins.str]):
...
class _GroupBadgeState:
    def __init__(__self__, *,
                 ...
                 link_url: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 rendered_image_url: Optional[pulumi.Input[builtins.str]] = None,
                 rendered_link_url: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] link_url: The url linked with the badge.
        :param pulumi.Input[builtins.str] name: The name of the badge.
        :param pulumi.Input[builtins.str] rendered_image_url: The image_url argument rendered (in case of use of placeholders).
        :param pulumi.Input[builtins.str] rendered_link_url: The link_url argument rendered (in case of use of placeholders).
        """
    ...
    @property
    @pulumi.getter(name="linkUrl")
    def link_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The url linked with the badge.
        """
        return pulumi.get(self, "link_url")
    ...
    @link_url.setter
    def link_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "link_url", value)
    ...
    def rendered_image_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def rendered_image_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "rendered_image_url", value)

    @property
    @pulumi.getter(name="renderedLinkUrl")
    def rendered_link_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def rendered_link_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class GroupBadge(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            rendered_image_url: Optional[pulumi.Input[builtins.str]] = None,
            rendered_link_url: Optional[pulumi.Input[builtins.str]] = None) -> 'GroupBadge':
        """
    ...
    @property
    @pulumi.getter(name="linkUrl")
    def link_url(self) -> pulumi.Output[builtins.str]:
        """
        The url linked with the badge.
        """
        return pulumi.get(self, "link_url")
    ...
    @property
    @pulumi.getter(name="renderedImageUrl")
    def rendered_image_url(self) -> pulumi.Output[builtins.str]:
        """
        The image_url argument rendered (in case of use of placeholders).
        """
        return pulumi.get(self, "rendered_image_url")
    ...
    @property
    @pulumi.getter(name="renderedLinkUrl")
    def rendered_link_url(self) -> pulumi.Output[builtins.str]:
        """
        The link_url argument rendered (in case of use of placeholders).
        """
        return pulumi.get(self, "rendered_link_url")
