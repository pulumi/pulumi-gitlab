...
class ProjectLevelNotificationsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] fixed_pipeline: Enable notifications for fixed pipelines. Can only be used when `level` is `custom`.
        :param pulumi.Input[_builtins.bool] issue_due: Enable notifications for due issues. Can only be used when `level` is `custom`.
        :param pulumi.Input[_builtins.str] level: The level of the notification. Valid values are: `disabled`, `participating`, `watch`, `global`, `mention`, `custom`.
        :param pulumi.Input[_builtins.bool] merge_merge_request: Enable notifications for merged merge requests. Can only be used when `level` is `custom`.
        :param pulumi.Input[_builtins.bool] merge_when_pipeline_succeeds: Enable notifications for merged merge requests when the pipeline succeeds. Can only be used when `level` is `custom`.
        :param pulumi.Input[_builtins.bool] moved_project: Enable notifications for moved projects. Can only be used when `level` is `custom`.
        :param pulumi.Input[_builtins.bool] new_issue: Enable notifications for new issues. Can only be used when `level` is `custom`.
        :param pulumi.Input[_builtins.bool] new_merge_request: Enable notifications for new merge requests. Can only be used when `level` is `custom`.
        :param pulumi.Input[_builtins.bool] new_note: Enable notifications for new notes on merge requests. Can only be used when `level` is `custom`.
        :param pulumi.Input[_builtins.bool] push_to_merge_request: Enable notifications for push to merge request branches. Can only be used when `level` is `custom`.
        :param pulumi.Input[_builtins.bool] reassign_issue: Enable notifications for issue reassignments. Can only be used when `level` is `custom`.
        :param pulumi.Input[_builtins.bool] reassign_merge_request: Enable notifications for merge request reassignments. Can only be used when `level` is `custom`.
        :param pulumi.Input[_builtins.bool] reopen_issue: Enable notifications for reopened issues. Can only be used when `level` is `custom`.
        :param pulumi.Input[_builtins.bool] reopen_merge_request: Enable notifications for reopened merge requests. Can only be used when `level` is `custom`.
        :param pulumi.Input[_builtins.bool] success_pipeline: Enable notifications for successful pipelines. Can only be used when `level` is `custom`.
        """
...
class ProjectLevelNotifications(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            reopen_issue: Optional[pulumi.Input[_builtins.bool]] = None,
            reopen_merge_request: Optional[pulumi.Input[_builtins.bool]] = None,
            success_pipeline: Optional[pulumi.Input[_builtins.bool]] = None) -> 'ProjectLevelNotifications':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="closeIssue")
    def close_issue(self) -> pulumi.Output[_builtins.bool]:
        """
        Enable notifications for closed issues. Can only be used when `level` is `custom`.
        """
        return pulumi.get(self, "close_issue")
    ...
    @_builtins.property
    @pulumi.getter(name="closeMergeRequest")
    def close_merge_request(self) -> pulumi.Output[_builtins.bool]:
        """
        Enable notifications for closed merge requests. Can only be used when `level` is `custom`.
        """
        return pulumi.get(self, "close_merge_request")
    ...
    @_builtins.property
    @pulumi.getter(name="failedPipeline")
    def failed_pipeline(self) -> pulumi.Output[_builtins.bool]:
        """
        Enable notifications for failed pipelines. Can only be used when `level` is `custom`.
        """
        return pulumi.get(self, "failed_pipeline")
    ...
    @_builtins.property
    @pulumi.getter(name="fixedPipeline")
    def fixed_pipeline(self) -> pulumi.Output[_builtins.bool]:
        """
        Enable notifications for fixed pipelines. Can only be used when `level` is `custom`.
        """
        return pulumi.get(self, "fixed_pipeline")
    ...
    @_builtins.property
    @pulumi.getter(name="issueDue")
    def issue_due(self) -> pulumi.Output[_builtins.bool]:
        """
        Enable notifications for due issues. Can only be used when `level` is `custom`.
        """
        return pulumi.get(self, "issue_due")
    ...
    @_builtins.property
    @pulumi.getter(name="mergeMergeRequest")
    def merge_merge_request(self) -> pulumi.Output[_builtins.bool]:
        """
        Enable notifications for merged merge requests. Can only be used when `level` is `custom`.
        """
        return pulumi.get(self, "merge_merge_request")
    ...
    @_builtins.property
    @pulumi.getter(name="mergeWhenPipelineSucceeds")
    def merge_when_pipeline_succeeds(self) -> pulumi.Output[_builtins.bool]:
        """
        Enable notifications for merged merge requests when the pipeline succeeds. Can only be used when `level` is `custom`.
        """
        return pulumi.get(self, "merge_when_pipeline_succeeds")
    ...
    @_builtins.property
    @pulumi.getter(name="movedProject")
    def moved_project(self) -> pulumi.Output[_builtins.bool]:
        """
        Enable notifications for moved projects. Can only be used when `level` is `custom`.
        """
        return pulumi.get(self, "moved_project")
    ...
    @_builtins.property
    @pulumi.getter(name="newIssue")
    def new_issue(self) -> pulumi.Output[_builtins.bool]:
        """
        Enable notifications for new issues. Can only be used when `level` is `custom`.
        """
        return pulumi.get(self, "new_issue")
    ...
    @_builtins.property
    @pulumi.getter(name="newMergeRequest")
    def new_merge_request(self) -> pulumi.Output[_builtins.bool]:
        """
        Enable notifications for new merge requests. Can only be used when `level` is `custom`.
        """
        return pulumi.get(self, "new_merge_request")
    ...
    @_builtins.property
    @pulumi.getter(name="newNote")
    def new_note(self) -> pulumi.Output[_builtins.bool]:
        """
        Enable notifications for new notes on merge requests. Can only be used when `level` is `custom`.
        """
        return pulumi.get(self, "new_note")
    ...
    @_builtins.property
    @pulumi.getter(name="pushToMergeRequest")
    def push_to_merge_request(self) -> pulumi.Output[_builtins.bool]:
        """
        Enable notifications for push to merge request branches. Can only be used when `level` is `custom`.
        """
        return pulumi.get(self, "push_to_merge_request")
    ...
    @_builtins.property
    @pulumi.getter(name="reassignIssue")
    def reassign_issue(self) -> pulumi.Output[_builtins.bool]:
        """
        Enable notifications for issue reassignments. Can only be used when `level` is `custom`.
        """
        return pulumi.get(self, "reassign_issue")
    ...
    @_builtins.property
    @pulumi.getter(name="reassignMergeRequest")
    def reassign_merge_request(self) -> pulumi.Output[_builtins.bool]:
        """
        Enable notifications for merge request reassignments. Can only be used when `level` is `custom`.
        """
        return pulumi.get(self, "reassign_merge_request")
    ...
    @_builtins.property
    @pulumi.getter(name="reopenIssue")
    def reopen_issue(self) -> pulumi.Output[_builtins.bool]:
        """
        Enable notifications for reopened issues. Can only be used when `level` is `custom`.
        """
        return pulumi.get(self, "reopen_issue")
    ...
    @_builtins.property
    @pulumi.getter(name="reopenMergeRequest")
    def reopen_merge_request(self) -> pulumi.Output[_builtins.bool]:
        """
        Enable notifications for reopened merge requests. Can only be used when `level` is `custom`.
        """
        return pulumi.get(self, "reopen_merge_request")
    ...
    @_builtins.property
    @pulumi.getter(name="successPipeline")
    def success_pipeline(self) -> pulumi.Output[_builtins.bool]:
        """
        Enable notifications for successful pipelines. Can only be used when `level` is `custom`.
        """
        return pulumi.get(self, "success_pipeline")
