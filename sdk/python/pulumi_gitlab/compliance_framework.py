...
class ComplianceFrameworkArgs:
    def __init__(__self__, *,
                 ...
                 pipeline_configuration_full_path: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ComplianceFramework resource.
        :param pulumi.Input[builtins.str] color: New color representation of the compliance framework in hex format. e.g. #FCA121.
        :param pulumi.Input[builtins.str] description: Description for the compliance framework.
        :param pulumi.Input[builtins.str] namespace_path: Full path of the namespace to add the compliance framework to.
        :param pulumi.Input[builtins.bool] default: Set this compliance framework as the default framework for the group. Default: `false`
        :param pulumi.Input[builtins.str] name: Name for the compliance framework.
        :param pulumi.Input[builtins.str] pipeline_configuration_full_path: Full path of the compliance pipeline configuration stored in a project repository, such as `.gitlab/.compliance-gitlab-ci.yml@compliance/hipaa`. Required format: `path/file.y[a]ml@group-name/project-name` **Note**: Ultimate license required.
        """
    ...
    @color.setter
    def color(self, value: pulumi.Input[builtins.str]):
    ...
    def pipeline_configuration_full_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def pipeline_configuration_full_path(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ComplianceFrameworkState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] default: Set this compliance framework as the default framework for the group. Default: `false`
        :param pulumi.Input[builtins.str] description: Description for the compliance framework.
        :param pulumi.Input[builtins.str] framework_id: Globally unique ID of the compliance framework.
        :param pulumi.Input[builtins.str] name: Name for the compliance framework.
        :param pulumi.Input[builtins.str] namespace_path: Full path of the namespace to add the compliance framework to.
        :param pulumi.Input[builtins.str] pipeline_configuration_full_path: Full path of the compliance pipeline configuration stored in a project repository, such as `.gitlab/.compliance-gitlab-ci.yml@compliance/hipaa`. Required format: `path/file.y[a]ml@group-name/project-name` **Note**: Ultimate license required.
        """
...
class ComplianceFramework(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            namespace_path: Optional[pulumi.Input[builtins.str]] = None,
            pipeline_configuration_full_path: Optional[pulumi.Input[builtins.str]] = None) -> 'ComplianceFramework':
        """
    ...
    @property
    @pulumi.getter(name="pipelineConfigurationFullPath")
    def pipeline_configuration_full_path(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Full path of the compliance pipeline configuration stored in a project repository, such as `.gitlab/.compliance-gitlab-ci.yml@compliance/hipaa`. Required format: `path/file.y[a]ml@group-name/project-name` **Note**: Ultimate license required.
        """
        return pulumi.get(self, "pipeline_configuration_full_path")
