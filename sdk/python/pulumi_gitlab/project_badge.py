...
class ProjectBadgeArgs:
    ...
    def link_url(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @link_url.setter
    def link_url(self, value: pulumi.Input[_builtins.str]):
...
class ProjectBadge(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/user/project/badges/#project-badges)
        ...
        Starting in Terraform v1.5.0, you can use an import block to import `ProjectBadge`. For example:
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[_builtins.str]] = None,
            rendered_image_url: Optional[pulumi.Input[_builtins.str]] = None,
            rendered_link_url: Optional[pulumi.Input[_builtins.str]] = None) -> 'ProjectBadge':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="linkUrl")
    def link_url(self) -> pulumi.Output[_builtins.str]:
        """
        The url linked with the badge.
        """
        return pulumi.get(self, "link_url")
    ...
    @_builtins.property
    @pulumi.getter(name="renderedImageUrl")
    def rendered_image_url(self) -> pulumi.Output[_builtins.str]:
        """
        The image_url argument rendered (in case of use of placeholders).
        """
        return pulumi.get(self, "rendered_image_url")
    ...
    @_builtins.property
    @pulumi.getter(name="renderedLinkUrl")
    def rendered_link_url(self) -> pulumi.Output[_builtins.str]:
        """
        The link_url argument rendered (in case of use of placeholders).
        """
        return pulumi.get(self, "rendered_link_url")
