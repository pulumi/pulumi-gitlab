...
class RepositoryFileArgs:
    def __init__(__self__, *,
                 ...
                 update_commit_message: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] author_name: Name of the commit author.
        ...
        :param pulumi.Input[builtins.str] update_commit_message: Update commit message.
        """
    ...
    def create_commit_message(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def create_commit_message(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "create_commit_message", value)

    @property
    @pulumi.getter(name="deleteCommitMessage")
    def delete_commit_message(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def delete_commit_message(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def execute_filemode(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def start_branch(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @start_branch.setter
    def start_branch(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "start_branch", value)

    @property
    @pulumi.getter(name="updateCommitMessage")
    def update_commit_message(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def update_commit_message(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _RepositoryFileState:
    def __init__(__self__, *,
                 author_email: Optional[pulumi.Input[builtins.str]] = None,
                 author_name: Optional[pulumi.Input[builtins.str]] = None,
                 blob_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 content_sha256: Optional[pulumi.Input[builtins.str]] = None,
                 create_commit_message: Optional[pulumi.Input[builtins.str]] = None,
                 delete_commit_message: Optional[pulumi.Input[builtins.str]] = None,
                 encoding: Optional[pulumi.Input[builtins.str]] = None,
                 execute_filemode: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] author_email: Email of the commit author.
        :param pulumi.Input[builtins.str] author_name: Name of the commit author.
        :param pulumi.Input[builtins.str] blob_id: The blob id.
        :param pulumi.Input[builtins.str] branch: Name of the branch to which to commit to.
        ...
        :param pulumi.Input[builtins.str] file_path: The full path of the file. It must be relative to the root of the project without a leading slash `/` or `./`.
        :param pulumi.Input[builtins.str] last_commit_id: The last known commit id.
        :param pulumi.Input[builtins.bool] overwrite_on_create: Enable overwriting existing files, defaults to `false`. This attribute is only used during `create` and must be use carefully. We suggest to use `imports` whenever possible and limit the use of this attribute for when the project was imported on the same `apply`. This attribute is not supported during a resource import.
        :param pulumi.Input[builtins.str] project: The name or ID of the project.
        :param pulumi.Input[builtins.str] ref: The name of branch, tag or commit.
    ...
    def blob_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The blob id.
        """
    ...
    @blob_id.setter
    def blob_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def content_sha256(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def content_sha256(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RepositoryFile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            size: Optional[pulumi.Input[builtins.int]] = None,
            start_branch: Optional[pulumi.Input[builtins.str]] = None,
            update_commit_message: Optional[pulumi.Input[builtins.str]] = None) -> 'RepositoryFile':
        """
    ...
    @property
    @pulumi.getter(name="authorEmail")
    def author_email(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Email of the commit author.
        """
        return pulumi.get(self, "author_email")
    ...
    @property
    @pulumi.getter(name="authorName")
    def author_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the commit author.
        """
        return pulumi.get(self, "author_name")
    ...
    @property
    @pulumi.getter(name="blobId")
    def blob_id(self) -> pulumi.Output[builtins.str]:
        """
        The blob id.
        """
        return pulumi.get(self, "blob_id")
    ...
    @property
    @pulumi.getter(name="commitMessage")
    def commit_message(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Commit message.
        """
        return pulumi.get(self, "commit_message")
    ...
    @property
    @pulumi.getter(name="contentSha256")
    def content_sha256(self) -> pulumi.Output[builtins.str]:
        """
        File content sha256 digest.
        """
        return pulumi.get(self, "content_sha256")
    ...
    @property
    @pulumi.getter(name="createCommitMessage")
    def create_commit_message(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Create commit message.
        """
        return pulumi.get(self, "create_commit_message")
    ...
    @property
    @pulumi.getter(name="deleteCommitMessage")
    def delete_commit_message(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Delete Commit message.
        """
        return pulumi.get(self, "delete_commit_message")
    ...
    @property
    @pulumi.getter(name="executeFilemode")
    def execute_filemode(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enables or disables the execute flag on the file.
        """
        return pulumi.get(self, "execute_filemode")
    ...
    @property
    @pulumi.getter(name="startBranch")
    def start_branch(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the branch to start the new commit from.
        """
        return pulumi.get(self, "start_branch")
    ...
    @property
    @pulumi.getter(name="updateCommitMessage")
    def update_commit_message(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Update commit message.
        """
        return pulumi.get(self, "update_commit_message")
