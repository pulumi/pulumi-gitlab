...
class RepositoryFileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] file_path: The full path of the file. It must be relative to the root of the project without a leading slash `/` or `./`.
        ...
        :param pulumi.Input[_builtins.str] commit_message: Commit message.
        :param pulumi.Input[_builtins.str] create_commit_message: Create commit message.
        :param pulumi.Input[_builtins.str] delete_commit_message: Delete Commit message.
        :param pulumi.Input[_builtins.bool] execute_filemode: Enables or disables the execute flag on the file.
        :param pulumi.Input[_builtins.bool] overwrite_on_create: Enable overwriting existing files, defaults to `false`. This attribute is only used during `create` and must be use carefully. We suggest to use `imports` whenever possible and limit the use of this attribute for when the project was imported on the same `apply`. This attribute is not supported during a resource import.
        :param pulumi.Input[_builtins.str] start_branch: Name of the branch to start the new commit from.
        :param pulumi.Input[_builtins.str] update_commit_message: Update commit message.
        """
...
class _RepositoryFileState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] commit_message: Commit message.
        :param pulumi.Input[_builtins.str] content: File content.
        :param pulumi.Input[_builtins.str] content_sha256: File content sha256 digest.
        :param pulumi.Input[_builtins.str] create_commit_message: Create commit message.
        :param pulumi.Input[_builtins.str] delete_commit_message: Delete Commit message.
        :param pulumi.Input[_builtins.str] encoding: The file content encoding. Valid values are: `base64`, `text`.
        :param pulumi.Input[_builtins.bool] execute_filemode: Enables or disables the execute flag on the file.
        :param pulumi.Input[_builtins.str] file_name: The filename.
        :param pulumi.Input[_builtins.str] file_path: The full path of the file. It must be relative to the root of the project without a leading slash `/` or `./`.
        :param pulumi.Input[_builtins.str] last_commit_id: The last known commit id.
        :param pulumi.Input[_builtins.bool] overwrite_on_create: Enable overwriting existing files, defaults to `false`. This attribute is only used during `create` and must be use carefully. We suggest to use `imports` whenever possible and limit the use of this attribute for when the project was imported on the same `apply`. This attribute is not supported during a resource import.
        :param pulumi.Input[_builtins.str] project: The name or ID of the project.
        :param pulumi.Input[_builtins.str] ref: The name of branch, tag or commit.
        :param pulumi.Input[_builtins.int] size: The file size.
        :param pulumi.Input[_builtins.str] start_branch: Name of the branch to start the new commit from.
        :param pulumi.Input[_builtins.str] update_commit_message: Update commit message.
        """
        if author_email is not None:
...
class RepositoryFile(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="authorName")
    def author_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Name of the commit author.
        """
        return pulumi.get(self, "author_name")
    ...
    @_builtins.property
    @pulumi.getter(name="createCommitMessage")
    def create_commit_message(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Create commit message.
        """
        return pulumi.get(self, "create_commit_message")
    ...
    @_builtins.property
    @pulumi.getter(name="deleteCommitMessage")
    def delete_commit_message(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Delete Commit message.
        """
        return pulumi.get(self, "delete_commit_message")
    ...
    @_builtins.property
    @pulumi.getter(name="executeFilemode")
    def execute_filemode(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Enables or disables the execute flag on the file.
        """
        return pulumi.get(self, "execute_filemode")
    ...
    @_builtins.property
    @pulumi.getter(name="startBranch")
    def start_branch(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Name of the branch to start the new commit from.
        """
        return pulumi.get(self, "start_branch")
    ...
    @_builtins.property
    @pulumi.getter(name="updateCommitMessage")
    def update_commit_message(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Update commit message.
        """
        return pulumi.get(self, "update_commit_message")
