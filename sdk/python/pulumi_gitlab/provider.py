...
class ProviderArgs:
    def __init__(__self__, *,
                 ...
                 early_auth_check: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] base_url: This is the target GitLab base API endpoint. Providing a value is a requirement when working with GitLab CE or GitLab
        ...
        :param pulumi.Input[builtins.str] cacert_file: This is a file containing the ca cert to verify the gitlab instance. This is available for use when working with GitLab
               CE or Gitlab Enterprise with a locally-issued or self-signed certificate chain.
        :param pulumi.Input[builtins.str] client_cert: File path to client certificate when GitLab instance is behind company proxy. File must contain PEM encoded data.
        :param pulumi.Input[builtins.str] client_key: File path to client key when GitLab instance is behind company proxy. File must contain PEM encoded data. Required when
               `client_cert` is set.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] headers: A map of headers to append to all API request to the GitLab instance.
        :param pulumi.Input[builtins.bool] insecure: When set to true this disables SSL verification of the connection to the GitLab instance.
        :param pulumi.Input[builtins.int] retries: The number of retries to execute when receiving a 429 Rate Limit error. Each retry will exponentially back off.
        :param pulumi.Input[builtins.str] token: The OAuth2 Token, Project, Group, Personal Access Token or CI Job Token used to connect to GitLab. The OAuth method is
    ...
    def early_auth_check(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "early_auth_check")

    @early_auth_check.setter
    def early_auth_check(self, value: Optional[pulumi.Input[builtins.bool]]):
