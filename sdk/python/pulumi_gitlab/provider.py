...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] context: The context to use for authentication and configuration. The context must exist in the configuration file. It may be
