...
class GroupProjectFileTemplateArgs:
    def __init__(__self__, *,
                 file_template_project_id: pulumi.Input[_builtins.int],
    ...
    def file_template_project_id(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    def file_template_project_id(self, value: pulumi.Input[_builtins.int]):
