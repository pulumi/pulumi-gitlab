...
class GroupCustomAttributeArgs:
    def __init__(__self__, *,
                 group: pulumi.Input[_builtins.int],
    ...
    @_builtins.property
    @pulumi.getter
    def group(self) -> pulumi.Input[_builtins.int]:
        """
        The id of the group.
        """
    ...
    @group.setter
    def group(self, value: pulumi.Input[_builtins.int]):
...
class GroupCustomAttribute(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/custom_attributes/)
        ...
        Starting in Terraform v1.5.0, you can use an import block to import `GroupCustomAttribute`. For example:
    ...
    @_builtins.property
    @pulumi.getter
    def group(self) -> pulumi.Output[_builtins.int]:
        """
        The id of the group.
        """
        return pulumi.get(self, "group")
