...
class ProjectTargetBranchRuleArgs:
    def __init__(__self__, *,
                 ...
                 source_branch_pattern: pulumi.Input[builtins.str],
                 target_branch_name: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] source_branch_pattern: A pattern matching the branch name for which the merge request should have a default target branch configured.
        :param pulumi.Input[builtins.str] target_branch_name: The name of the branch to which the merge request should be addressed.
        """
    ...
    def source_branch_pattern(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_branch_pattern(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "source_branch_pattern", value)

    @property
    @pulumi.getter(name="targetBranchName")
    def target_branch_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def target_branch_name(self, value: pulumi.Input[builtins.str]):
...
class _ProjectTargetBranchRuleState:
    def __init__(__self__, *,
                 ...
                 source_branch_pattern: Optional[pulumi.Input[builtins.str]] = None,
                 target_branch_name: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="sourceBranchPattern")
    def source_branch_pattern(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A pattern matching the branch name for which the merge request should have a default target branch configured.
        """
        return pulumi.get(self, "source_branch_pattern")
    ...
    @source_branch_pattern.setter
    def source_branch_pattern(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_branch_pattern", value)

    @property
    @pulumi.getter(name="targetBranchName")
    def target_branch_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the branch to which the merge request should be addressed.
        """
        return pulumi.get(self, "target_branch_name")
    ...
    @target_branch_name.setter
    def target_branch_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_branch_name", value)
...
class ProjectTargetBranchRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            source_branch_pattern: Optional[pulumi.Input[builtins.str]] = None,
            target_branch_name: Optional[pulumi.Input[builtins.str]] = None) -> 'ProjectTargetBranchRule':
        """
    ...
    @property
    @pulumi.getter(name="sourceBranchPattern")
    def source_branch_pattern(self) -> pulumi.Output[builtins.str]:
        """
        A pattern matching the branch name for which the merge request should have a default target branch configured.
        """
        return pulumi.get(self, "source_branch_pattern")
    ...
    @property
    @pulumi.getter(name="targetBranchName")
    def target_branch_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the branch to which the merge request should be addressed.
        """
        return pulumi.get(self, "target_branch_name")
