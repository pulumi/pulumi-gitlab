...
class GetGroupSubgroupsResult:
    ...
    def all_available(self) -> builtins.bool:
        """
    ...
    def skip_groups(self) -> Sequence[builtins.int]:
        """
    ...
    @property
    @pulumi.getter
    def statistics(self) -> builtins.bool:
        """
    ...
    def with_custom_attributes(self) -> builtins.bool:
        """
...
def get_group_subgroups(all_available: Optional[builtins.bool] = None,
                        group_id: Optional[builtins.int] = None,
                        min_access_level: Optional[builtins.str] = None,
                        order_by: Optional[builtins.str] = None,
                        owned: Optional[builtins.bool] = None,
                        search: Optional[builtins.str] = None,
                        skip_groups: Optional[Sequence[builtins.int]] = None,
    ...
    **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/groups/#list-a-groups-subgroups)
    ...
    :param builtins.bool all_available: Show all the groups you have access to.
    :param builtins.int group_id: The ID of the group.
    :param builtins.str min_access_level: Limit to groups where current user has at least this access level.
    :param builtins.str order_by: Order groups by name, path or id.
    :param builtins.bool owned: Limit to groups explicitly owned by the current user.
    :param builtins.str search: Return the list of authorized groups matching the search criteria.
    :param Sequence[builtins.int] skip_groups: Skip the group IDs passed.
    :param builtins.str sort: Order groups in asc or desc order.
    :param builtins.bool statistics: Include group statistics (administrators only).
    :param builtins.bool with_custom_attributes: Include custom attributes in response (administrators only).
    """
    __args__ = dict()
...
def get_group_subgroups_output(all_available: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                               group_id: Optional[pulumi.Input[builtins.int]] = None,
                               min_access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               ...
                               skip_groups: Optional[pulumi.Input[Optional[Sequence[builtins.int]]]] = None,
