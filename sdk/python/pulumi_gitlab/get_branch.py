...
class GetBranchResult:
    ...
    def developer_can_merge(self) -> _builtins.bool:
        """
    ...
    def developer_can_push(self) -> _builtins.bool:
        """
...
def get_branch(name: Optional[_builtins.str] = None,
    ...
    **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/branches/#get-single-repository-branch)
    ...
    :param _builtins.str project: The full path or id of the project.
    """
    __args__ = dict()
    __args__['name'] = name
