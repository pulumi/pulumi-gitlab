...
__all__ = ['ProjectIntegrationGoogleChatArgs', 'ProjectIntegrationGoogleChat']

@pulumi.input_type
class ProjectIntegrationGoogleChatArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] project: The ID or full path of the project to integrate with Google Chat.
        :param pulumi.Input[_builtins.str] webhook: The Google Chat webhook URL (for example, https://chat.googleapis.com/v1/spaces/...).
        ...
        :param pulumi.Input[_builtins.bool] notify_only_broken_pipelines: Send notifications for broken pipelines only.
...
@pulumi.input_type
class _ProjectIntegrationGoogleChatState:
    def __init__(__self__, *,
...
@pulumi.type_token("gitlab:index/projectIntegrationGoogleChat:ProjectIntegrationGoogleChat")
class ProjectIntegrationGoogleChat(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/project_integrations/#set-up-google-chat)
        ...
        :param str resource_name: The name of the resource.
        :param ProjectIntegrationGoogleChatArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ProjectIntegrationGoogleChatArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ProjectIntegrationGoogleChatArgs.__new__(ProjectIntegrationGoogleChatArgs)
        ...
        super(ProjectIntegrationGoogleChat, __self__).__init__(
            'gitlab:index/projectIntegrationGoogleChat:ProjectIntegrationGoogleChat',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            tag_push_events: pulumi.Input[Optional[_builtins.bool]] = None,
            webhook: pulumi.Input[Optional[_builtins.str]] = None,
            wiki_page_events: pulumi.Input[Optional[_builtins.bool]] = None) -> 'ProjectIntegrationGoogleChat':
        """
        ...
        __props__ = _ProjectIntegrationGoogleChatState.__new__(_ProjectIntegrationGoogleChatState)
        ...
        __props__.__dict__["wiki_page_events"] = wiki_page_events
        return ProjectIntegrationGoogleChat(resource_name, opts=opts, __props__=__props__)
