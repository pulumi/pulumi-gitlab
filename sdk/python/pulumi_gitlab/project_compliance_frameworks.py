...
class ProjectComplianceFrameworksArgs:
    def __init__(__self__, *,
                 compliance_framework_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
    ...
    def compliance_framework_ids(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
    ...
    def compliance_framework_ids(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class ProjectComplianceFrameworks(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="complianceFrameworkIds")
    def compliance_framework_ids(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Globally unique IDs of the compliance frameworks to assign to the project.
        """
        return pulumi.get(self, "compliance_framework_ids")
