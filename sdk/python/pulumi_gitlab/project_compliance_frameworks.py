...
class ProjectComplianceFrameworksArgs:
    def __init__(__self__, *,
                 compliance_framework_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 project: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a ProjectComplianceFrameworks resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] compliance_framework_ids: Globally unique IDs of the compliance frameworks to assign to the project.
        :param pulumi.Input[builtins.str] project: The ID or full path of the project to change the compliance frameworks of.
        """
    ...
    def compliance_framework_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def compliance_framework_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class _ProjectComplianceFrameworksState:
    def __init__(__self__, *,
                 compliance_framework_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter(name="complianceFrameworkIds")
    def compliance_framework_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Globally unique IDs of the compliance frameworks to assign to the project.
        """
        return pulumi.get(self, "compliance_framework_ids")
    ...
    @compliance_framework_ids.setter
    def compliance_framework_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "compliance_framework_ids", value)
...
@pulumi.type_token("gitlab:index/projectComplianceFrameworks:ProjectComplianceFrameworks")
class ProjectComplianceFrameworks(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            compliance_framework_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None) -> 'ProjectComplianceFrameworks':
        """
    ...
    @property
    @pulumi.getter(name="complianceFrameworkIds")
    def compliance_framework_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Globally unique IDs of the compliance frameworks to assign to the project.
        """
        return pulumi.get(self, "compliance_framework_ids")
