...
class IntegrationGithub(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/project_integrations/#github)
        ...
        Starting in Terraform v1.5.0, you can use an import block to import `IntegrationGithub`. For example:

        Importing using the CLI is supported with the following syntax:

        You can import a IntegrationGithub state using `terraform import <resource> <project_id>`:
    ...
    def get(resource_name: str,
            ...
            title: Optional[pulumi.Input[_builtins.str]] = None,
            token: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None) -> 'IntegrationGithub':
        """
