...
class UserCustomAttributeArgs:
    def __init__(__self__, *,
                 ...
                 user: pulumi.Input[_builtins.int],
        ...
        :param pulumi.Input[_builtins.int] user: The id of the user.
    ...
    @_builtins.property
    @pulumi.getter
    def user(self) -> pulumi.Input[_builtins.int]:
        """
        The id of the user.
        """
    ...
    @user.setter
    def user(self, value: pulumi.Input[_builtins.int]):
...
class UserCustomAttribute(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/custom_attributes/)
        ...
        Starting in Terraform v1.5.0, you can use an import block to import `UserCustomAttribute`. For example:
    ...
    @_builtins.property
    @pulumi.getter
    def user(self) -> pulumi.Output[_builtins.int]:
        """
        The id of the user.
        """
        return pulumi.get(self, "user")
