...
class ProjectMembershipArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] access_level: The access level for the member. Valid values are: `no one`, `minimal`, `guest`, `planner`, `reporter`, `security_manager`, `developer`, `maintainer`, `owner`
    ...
    def access_level(self) -> pulumi.Input[_builtins.str]:
        """
        The access level for the member. Valid values are: `no one`, `minimal`, `guest`, `planner`, `reporter`, `security_manager`, `developer`, `maintainer`, `owner`
        """
