...
class ProjectMembershipArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_level: The access level for the member. Valid values are: `no one`, `minimal`, `guest`, `reporter`, `developer`, `maintainer`, `owner`
