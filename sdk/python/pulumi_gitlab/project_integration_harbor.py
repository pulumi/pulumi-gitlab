...
class ProjectIntegrationHarbor(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        **Upstream API**: [GitLab REST API docs](https://docs.gitlab.com/api/project_integrations/#harbor)
        ...
        Starting in Terraform v1.5.0, you can use an import block to import `ProjectIntegrationHarbor`. For example:

        Importing using the CLI is supported with the following syntax:

        You can import a ProjectIntegrationHarbor state using `terraform import <resource> <project_id>`:
    ...
    def get(resource_name: str,
            ...
            url: pulumi.Input[Optional[_builtins.str]] = None,
            use_inherited_settings: pulumi.Input[Optional[_builtins.bool]] = None,
            username: pulumi.Input[Optional[_builtins.str]] = None) -> 'ProjectIntegrationHarbor':
        """
