...
class ProjectMilestoneArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] project: The ID or URL-encoded path of the project owned by the authenticated user.
        :param pulumi.Input[builtins.str] title: The title of a milestone.
        :param pulumi.Input[builtins.str] description: The description of the milestone.
        :param pulumi.Input[builtins.str] due_date: The due date of the milestone. Date time string in the format YYYY-MM-DD, for example 2016-03-11.
        :param pulumi.Input[builtins.str] start_date: The start date of the milestone. Date time string in the format YYYY-MM-DD, for example 2016-03-11.
        :param pulumi.Input[builtins.str] state: The state of the milestone. Valid values are: `active`, `closed`.
        """
...
class _ProjectMilestoneState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: The time of creation of the milestone. Date time string, ISO 8601 formatted, for example 2016-03-11T03:45:40Z.
        :param pulumi.Input[builtins.str] description: The description of the milestone.
        :param pulumi.Input[builtins.str] due_date: The due date of the milestone. Date time string in the format YYYY-MM-DD, for example 2016-03-11.
        :param pulumi.Input[builtins.bool] expired: Bool, true if milestone expired.
        :param pulumi.Input[builtins.int] iid: The ID of the project's milestone.
        :param pulumi.Input[builtins.int] milestone_id: The instance-wide ID of the project’s milestone.
        :param pulumi.Input[builtins.str] project: The ID or URL-encoded path of the project owned by the authenticated user.
        :param pulumi.Input[builtins.int] project_id: The project ID of milestone.
        :param pulumi.Input[builtins.str] start_date: The start date of the milestone. Date time string in the format YYYY-MM-DD, for example 2016-03-11.
        :param pulumi.Input[builtins.str] state: The state of the milestone. Valid values are: `active`, `closed`.
        :param pulumi.Input[builtins.str] title: The title of a milestone.
        :param pulumi.Input[builtins.str] updated_at: The last update time of the milestone. Date time string, ISO 8601 formatted, for example 2016-03-11T03:45:40Z.
        :param pulumi.Input[builtins.str] web_url: The web URL of the milestone.
        """
...
class ProjectMilestone(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            title: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            web_url: Optional[pulumi.Input[builtins.str]] = None) -> 'ProjectMilestone':
        """
    ...
    @property
    @pulumi.getter(name="milestoneId")
    def milestone_id(self) -> pulumi.Output[builtins.int]:
        """
        The instance-wide ID of the project’s milestone.
        """
        return pulumi.get(self, "milestone_id")
