...
class ProjectMergeRequestNoteArgs:
    def __init__(__self__, *,
                 ...
                 merge_request_iid: pulumi.Input[builtins.int],
                 project: pulumi.Input[builtins.str],
                 created_at: Optional[pulumi.Input[builtins.str]] = None,
                 internal: Optional[pulumi.Input[builtins.bool]] = None,
                 merge_request_diff_head_sha: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ProjectMergeRequestNote resource.
        :param pulumi.Input[builtins.str] body: The body of the merge request note.
        :param pulumi.Input[builtins.int] merge_request_iid: The IID of the merge request to add the note to.
        :param pulumi.Input[builtins.str] project: The ID or path of the project to add the note to.
        :param pulumi.Input[builtins.str] created_at: The creation date of the merge request note. Using this field requires the token used with the provider to either be an Admin, or hava a Project or Group Owner role.
        :param pulumi.Input[builtins.bool] internal: Indicates if the merge request note is internal.
        :param pulumi.Input[builtins.str] merge_request_diff_head_sha: The diff head SHA of the merge request when the note was created.
        """
    ...
    def merge_request_iid(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def merge_request_iid(self, value: pulumi.Input[builtins.int]):
    ...
    def merge_request_diff_head_sha(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def merge_request_diff_head_sha(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ProjectMergeRequestNoteState:
    def __init__(__self__, *,
                 ...
                 internal: Optional[pulumi.Input[builtins.bool]] = None,
                 merge_request_diff_head_sha: Optional[pulumi.Input[builtins.str]] = None,
                 merge_request_iid: Optional[pulumi.Input[builtins.int]] = None,
                 note_id: Optional[pulumi.Input[builtins.int]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 resolvable: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] merge_request_diff_head_sha: The diff head SHA of the merge request when the note was created.
        :param pulumi.Input[builtins.int] merge_request_iid: The IID of the merge request to add the note to.
        :param pulumi.Input[builtins.int] note_id: The ID of the merge request note.
        :param pulumi.Input[builtins.str] project: The ID or path of the project to add the note to.
        :param pulumi.Input[builtins.bool] resolvable: Indicates if the merge request note is resolvable.
        :param pulumi.Input[builtins.bool] system: Indicates if the merge request note is a system note.
        :param pulumi.Input[builtins.str] updated_at: The last updated date of the merge request note.
        """
        if body is not None:
            pulumi.set(__self__, "body", body)
        if created_at is not None:
    ...
    @property
    @pulumi.getter(name="mergeRequestIid")
    def merge_request_iid(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The IID of the merge request to add the note to.
        """
        return pulumi.get(self, "merge_request_iid")
    ...
    @merge_request_iid.setter
    def merge_request_iid(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "merge_request_iid", value)

    @property
    @pulumi.getter(name="noteId")
    def note_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @note_id.setter
    def note_id(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    @property
    @pulumi.getter
    def resolvable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @resolvable.setter
    def resolvable(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ProjectMergeRequestNote(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resolvable: Optional[pulumi.Input[builtins.bool]] = None,
            system: Optional[pulumi.Input[builtins.bool]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'ProjectMergeRequestNote':
        """
    ...
    @property
    @pulumi.getter(name="mergeRequestDiffHeadSha")
    def merge_request_diff_head_sha(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The diff head SHA of the merge request when the note was created.
        """
        return pulumi.get(self, "merge_request_diff_head_sha")
    ...
    @property
    @pulumi.getter(name="mergeRequestIid")
    def merge_request_iid(self) -> pulumi.Output[builtins.int]:
        """
        The IID of the merge request to add the note to.
        """
        return pulumi.get(self, "merge_request_iid")
    ...
    @property
    @pulumi.getter(name="noteId")
    def note_id(self) -> pulumi.Output[builtins.int]:
        """
        The ID of the merge request note.
        """
        return pulumi.get(self, "note_id")
    ...
    @property
    @pulumi.getter
    def resolvable(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates if the merge request note is resolvable.
        """
        return pulumi.get(self, "resolvable")
    ...
    @property
    @pulumi.getter
    def system(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates if the merge request note is a system note.
        """
        return pulumi.get(self, "system")
