...
class GroupShareGroupArgs:
    def __init__(__self__, *,
                 ...
                 share_group_id: pulumi.Input[builtins.int],
        ...
        :param pulumi.Input[builtins.str] group_access: The access level to grant the group. Valid values are: `no one`, `minimal`, `guest`, `reporter`, `developer`, `maintainer`, `owner`
    ...
    def share_group_id(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def share_group_id(self, value: pulumi.Input[builtins.int]):
...
class _GroupShareGroupState:
    def __init__(__self__, *,
                 ...
                 member_role_id: Optional[pulumi.Input[builtins.int]] = None,
                 share_group_id: Optional[pulumi.Input[builtins.int]] = None):
        """
    ...
    @property
    @pulumi.getter(name="shareGroupId")
    def share_group_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The id of the additional group with which the main group will be shared.
        """
        return pulumi.get(self, "share_group_id")
    ...
    @share_group_id.setter
    def share_group_id(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "share_group_id", value)
...
class GroupShareGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            group_id: Optional[pulumi.Input[builtins.str]] = None,
            member_role_id: Optional[pulumi.Input[builtins.int]] = None,
            share_group_id: Optional[pulumi.Input[builtins.int]] = None) -> 'GroupShareGroup':
        """
    ...
    @property
    @pulumi.getter(name="shareGroupId")
    def share_group_id(self) -> pulumi.Output[builtins.int]:
        """
        The id of the additional group with which the main group will be shared.
        """
        return pulumi.get(self, "share_group_id")
