...
class ProjectCustomAttributeArgs:
    def __init__(__self__, *,
                 ...
                 project: pulumi.Input[builtins.int],
                 value: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a ProjectCustomAttribute resource.
        :param pulumi.Input[builtins.str] key: Key for the Custom Attribute.
        :param pulumi.Input[builtins.int] project: The id of the project.
        :param pulumi.Input[builtins.str] value: Value for the Custom Attribute.
        """
    ...
    @property
    @pulumi.getter
    def project(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @project.setter
    def project(self, value: pulumi.Input[builtins.int]):
...
class _ProjectCustomAttributeState:
    def __init__(__self__, *,
                 ...
                 project: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter
    def project(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The id of the project.
        """
        return pulumi.get(self, "project")
    ...
    @project.setter
    def project(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "project", value)
...
@pulumi.type_token("gitlab:index/projectCustomAttribute:ProjectCustomAttribute")
class ProjectCustomAttribute(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            key: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.int]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'ProjectCustomAttribute':
        """
    ...
    @property
    @pulumi.getter
    def project(self) -> pulumi.Output[builtins.int]:
        """
        The id of the project.
        """
        return pulumi.get(self, "project")
