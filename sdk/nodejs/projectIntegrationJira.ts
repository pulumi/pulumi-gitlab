 ...
 * });
 * const jira = new gitlab.ProjectIntegrationJira("jira", {
 ...
 * ```
 */
export class ProjectIntegrationJira extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProjectIntegrationJiraState, opts?: pulumi.CustomResourceOptions): ProjectIntegrationJira {
        return new ProjectIntegrationJira(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gitlab:index/projectIntegrationJira:ProjectIntegrationJira';

    /**
     * Returns true if the given object is an instance of ProjectIntegrationJira.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ProjectIntegrationJira {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ProjectIntegrationJira.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ProjectIntegrationJiraArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ProjectIntegrationJiraArgs | ProjectIntegrationJiraState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ProjectIntegrationJiraState | undefined;
            ...
            const args = argsOrState as ProjectIntegrationJiraArgs | undefined;
        ...
        super(ProjectIntegrationJira.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ProjectIntegrationJiraState {
    /**
     * Whether the integration is active.
     */
