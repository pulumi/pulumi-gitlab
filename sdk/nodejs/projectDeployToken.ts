 ...
 */
export class ProjectDeployToken extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProjectDeployTokenState, opts?: pulumi.CustomResourceOptions): ProjectDeployToken {
        return new ProjectDeployToken(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gitlab:index/projectDeployToken:ProjectDeployToken';

    /**
     * Returns true if the given object is an instance of ProjectDeployToken.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ProjectDeployToken {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ProjectDeployToken.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ProjectDeployTokenArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ProjectDeployTokenArgs | ProjectDeployTokenState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ProjectDeployTokenState | undefined;
            ...
            const args = argsOrState as ProjectDeployTokenArgs | undefined;
        ...
        super(ProjectDeployToken.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ProjectDeployTokenState {
    /**
     * True if the token is expired.
     */
 ...
 */
export interface ProjectDeployTokenArgs {
    /**
     * Time the token expires in RFC3339 format. Not set by default.
     */
    expiresAt?: pulumi.Input<string>;
