 ...
 * ```
 */
export class ProjectIntegrationCustomIssueTracker extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProjectIntegrationCustomIssueTrackerState, opts?: pulumi.CustomResourceOptions): ProjectIntegrationCustomIssueTracker {
        return new ProjectIntegrationCustomIssueTracker(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gitlab:index/projectIntegrationCustomIssueTracker:ProjectIntegrationCustomIssueTracker';

    /**
     * Returns true if the given object is an instance of ProjectIntegrationCustomIssueTracker.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ProjectIntegrationCustomIssueTracker {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ProjectIntegrationCustomIssueTracker.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ProjectIntegrationCustomIssueTrackerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ProjectIntegrationCustomIssueTrackerArgs | ProjectIntegrationCustomIssueTrackerState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ProjectIntegrationCustomIssueTracker.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ProjectIntegrationCustomIssueTrackerState {
    /**
     * Whether the integration is active.
     */
 ...
 */
export interface ProjectIntegrationCustomIssueTrackerArgs {
    /**
     * The URL to view an issue in the external issue tracker. Must contain :id.
     */
    issuesUrl: pulumi.Input<string>;
