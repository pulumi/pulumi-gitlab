...
export class ProjectComplianceFramework extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProjectComplianceFrameworkState, opts?: pulumi.CustomResourceOptions): ProjectComplianceFramework {
        return new ProjectComplianceFramework(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gitlab:index/projectComplianceFramework:ProjectComplianceFramework';

    /**
     * Returns true if the given object is an instance of ProjectComplianceFramework.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ProjectComplianceFramework {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ProjectComplianceFramework.__pulumiType;
    }

    /**
     * Globally unique ID of the compliance framework to assign to the project.
     */
    public readonly complianceFrameworkId!: pulumi.Output<string>;
    /**
     ...
     */
    constructor(name: string, args: ProjectComplianceFrameworkArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ProjectComplianceFrameworkArgs | ProjectComplianceFrameworkState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ProjectComplianceFrameworkState | undefined;
            resourceInputs["complianceFrameworkId"] = state ? state.complianceFrameworkId : undefined;
            resourceInputs["project"] = state ? state.project : undefined;
        } else {
            const args = argsOrState as ProjectComplianceFrameworkArgs | undefined;
            if ((!args || args.complianceFrameworkId === undefined) && !opts.urn) {
                throw new Error("Missing required property 'complianceFrameworkId'");
            }
            if ((!args || args.project === undefined) && !opts.urn) {
                throw new Error("Missing required property 'project'");
            }
            resourceInputs["complianceFrameworkId"] = args ? args.complianceFrameworkId : undefined;
            resourceInputs["project"] = args ? args.project : undefined;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(ProjectComplianceFramework.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ProjectComplianceFrameworkState {
    /**
     * Globally unique ID of the compliance framework to assign to the project.
     */
    complianceFrameworkId?: pulumi.Input<string>;
    /**
     * The ID or full path of the project to change the compliance framework of.
     */
 ...
 */
export interface ProjectComplianceFrameworkArgs {
    /**
     * Globally unique ID of the compliance framework to assign to the project.
     */
    complianceFrameworkId: pulumi.Input<string>;
