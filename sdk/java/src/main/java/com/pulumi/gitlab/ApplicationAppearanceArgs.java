...
public final class ApplicationAppearanceArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApplicationAppearanceArgs Empty = new ApplicationAppearanceArgs();
    ...
    private ApplicationAppearanceArgs() {}

    private ApplicationAppearanceArgs(ApplicationAppearanceArgs $) {
    ...
    public static Builder builder(ApplicationAppearanceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplicationAppearanceArgs();
        }

        public Builder(ApplicationAppearanceArgs defaults) {
            $ = new ApplicationAppearanceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApplicationAppearanceArgs build() {
            return $;
        }
    }
