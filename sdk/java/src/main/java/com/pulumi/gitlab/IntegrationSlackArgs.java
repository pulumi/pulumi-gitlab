...
public final class IntegrationSlackArgs extends com.pulumi.resources.ResourceArgs {

    public static final IntegrationSlackArgs Empty = new IntegrationSlackArgs();
    ...
    private IntegrationSlackArgs() {}

    private IntegrationSlackArgs(IntegrationSlackArgs $) {
    ...
    public static Builder builder(IntegrationSlackArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IntegrationSlackArgs();
        }

        public Builder(IntegrationSlackArgs defaults) {
            $ = new IntegrationSlackArgs(Objects.requireNonNull(defaults));
        }
        ...
        public IntegrationSlackArgs build() {
            if ($.project == null) {
                throw new MissingRequiredPropertyException("IntegrationSlackArgs", "project");
            }
            if ($.webhook == null) {
                throw new MissingRequiredPropertyException("IntegrationSlackArgs", "webhook");
            }
            return $;
        }
    }
