...
import com.pulumi.gitlab.ProjectIntegrationTelegramArgs;
import com.pulumi.gitlab.Utilities;
import com.pulumi.gitlab.inputs.ProjectIntegrationTelegramState;
 ...
 * import com.pulumi.gitlab.ProjectIntegrationTelegram;
 * import com.pulumi.gitlab.ProjectIntegrationTelegramArgs;
 ...
 *             .build());
 * 
 *         var default_ = new ProjectIntegrationTelegram("default", ProjectIntegrationTelegramArgs.builder()
 ...
 * ## Import
 * 
 * Starting in Terraform v1.5.0, you can use an import block to import `gitlab.ProjectIntegrationTelegram`. For example:
 * 
 ...
 * 
 */
@ResourceType(type="gitlab:index/projectIntegrationTelegram:ProjectIntegrationTelegram")
public class ProjectIntegrationTelegram extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ProjectIntegrationTelegram(java.lang.String name) {
        this(name, ProjectIntegrationTelegramArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ProjectIntegrationTelegram(java.lang.String name, ProjectIntegrationTelegramArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ProjectIntegrationTelegram(java.lang.String name, ProjectIntegrationTelegramArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gitlab:index/projectIntegrationTelegram:ProjectIntegrationTelegram", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ProjectIntegrationTelegram(java.lang.String name, Output<java.lang.String> id, @Nullable ProjectIntegrationTelegramState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gitlab:index/projectIntegrationTelegram:ProjectIntegrationTelegram", name, state, makeResourceOptions(options, id), false);
    }

    private static ProjectIntegrationTelegramArgs makeArgs(ProjectIntegrationTelegramArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ProjectIntegrationTelegramArgs.Empty : args;
    }
     ...
     */
    public static ProjectIntegrationTelegram get(java.lang.String name, Output<java.lang.String> id, @Nullable ProjectIntegrationTelegramState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new ProjectIntegrationTelegram(name, id, state, options);
    }
}
