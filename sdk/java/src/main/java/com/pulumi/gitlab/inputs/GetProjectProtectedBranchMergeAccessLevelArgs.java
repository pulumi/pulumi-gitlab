...
public final class GetProjectProtectedBranchMergeAccessLevelArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetProjectProtectedBranchMergeAccessLevelArgs Empty = new GetProjectProtectedBranchMergeAccessLevelArgs();
    ...
    private GetProjectProtectedBranchMergeAccessLevelArgs() {}

    private GetProjectProtectedBranchMergeAccessLevelArgs(GetProjectProtectedBranchMergeAccessLevelArgs $) {
    ...
    public static Builder builder(GetProjectProtectedBranchMergeAccessLevelArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetProjectProtectedBranchMergeAccessLevelArgs();
        }

        public Builder(GetProjectProtectedBranchMergeAccessLevelArgs defaults) {
            $ = new GetProjectProtectedBranchMergeAccessLevelArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetProjectProtectedBranchMergeAccessLevelArgs build() {
            if ($.accessLevel == null) {
                throw new MissingRequiredPropertyException("GetProjectProtectedBranchMergeAccessLevelArgs", "accessLevel");
            }
            if ($.accessLevelDescription == null) {
                throw new MissingRequiredPropertyException("GetProjectProtectedBranchMergeAccessLevelArgs", "accessLevelDescription");
            }
            return $;
        }
    }
