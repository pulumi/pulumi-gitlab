...
public final class ServicePipelinesEmailState extends com.pulumi.resources.ResourceArgs {

    public static final ServicePipelinesEmailState Empty = new ServicePipelinesEmailState();
    ...
    private ServicePipelinesEmailState() {}

    private ServicePipelinesEmailState(ServicePipelinesEmailState $) {
    ...
    public static Builder builder(ServicePipelinesEmailState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServicePipelinesEmailState();
        }

        public Builder(ServicePipelinesEmailState defaults) {
            $ = new ServicePipelinesEmailState(Objects.requireNonNull(defaults));
        }
        ...
        public ServicePipelinesEmailState build() {
            return $;
        }
    }
