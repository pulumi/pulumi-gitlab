...
import com.pulumi.gitlab.inputs.ProjectPushMirrorState;
 ...
 * 
 */
@ResourceType(type="gitlab:index/projectPushMirror:ProjectPushMirror")
public class ProjectPushMirror extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ProjectPushMirror(java.lang.String name) {
        this(name, ProjectPushMirrorArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ProjectPushMirror(java.lang.String name, ProjectPushMirrorArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ProjectPushMirror(java.lang.String name, ProjectPushMirrorArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gitlab:index/projectPushMirror:ProjectPushMirror", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ProjectPushMirror(java.lang.String name, Output<java.lang.String> id, @Nullable ProjectPushMirrorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gitlab:index/projectPushMirror:ProjectPushMirror", name, state, makeResourceOptions(options, id), false);
    }

    private static ProjectPushMirrorArgs makeArgs(ProjectPushMirrorArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ProjectPushMirrorArgs.Empty : args;
    }
     ...
     */
    public static ProjectPushMirror get(java.lang.String name, Output<java.lang.String> id, @Nullable ProjectPushMirrorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new ProjectPushMirror(name, id, state, options);
    }
}
