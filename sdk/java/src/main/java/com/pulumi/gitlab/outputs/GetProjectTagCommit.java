...
@CustomType
public final class GetProjectTagCommit {
    ...
    public static Builder builder(GetProjectTagCommit defaults) {
    ...
    public static final class Builder {
        ...
        private String title;
        public Builder() {}
        public Builder(GetProjectTagCommit defaults) {
        ...
        public GetProjectTagCommit build() {
            final var _resultValue = new GetProjectTagCommit();
