...
public final class GroupBranchProtectionAllowedToUnprotectArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupBranchProtectionAllowedToUnprotectArgs Empty = new GroupBranchProtectionAllowedToUnprotectArgs();
    ...
    private GroupBranchProtectionAllowedToUnprotectArgs() {}

    private GroupBranchProtectionAllowedToUnprotectArgs(GroupBranchProtectionAllowedToUnprotectArgs $) {
    ...
    public static Builder builder(GroupBranchProtectionAllowedToUnprotectArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupBranchProtectionAllowedToUnprotectArgs();
        }

        public Builder(GroupBranchProtectionAllowedToUnprotectArgs defaults) {
            $ = new GroupBranchProtectionAllowedToUnprotectArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param accessLevel Access level allowed to perform the relevant action. Mutually exclusive with `groupId` and `userId`. Valid values are: `developer`, `maintainer`, `admin`.
         * 
         * @return builder
         * 
         */
        ...
        public GroupBranchProtectionAllowedToUnprotectArgs build() {
            return $;
        }
    }
