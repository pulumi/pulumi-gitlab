...
@CustomType
public final class GroupBranchProtectionAllowedToUnprotect {
    /**
    ...
    private GroupBranchProtectionAllowedToUnprotect() {}
    /**
     * @return Access level allowed to perform the relevant action. Mutually exclusive with `groupId` and `userId`. Valid values are: `developer`, `maintainer`, `admin`.
     * 
     */
    ...
    public static Builder builder(GroupBranchProtectionAllowedToUnprotect defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer userId;
        public Builder() {}
        public Builder(GroupBranchProtectionAllowedToUnprotect defaults) {
        ...
        public GroupBranchProtectionAllowedToUnprotect build() {
            final var _resultValue = new GroupBranchProtectionAllowedToUnprotect();
