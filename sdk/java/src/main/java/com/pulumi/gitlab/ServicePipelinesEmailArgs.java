...
public final class ServicePipelinesEmailArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ServicePipelinesEmailArgs build() {
            if ($.project == null) {
                throw new MissingRequiredPropertyException("ServicePipelinesEmailArgs", "project");
            }
            if ($.recipients == null) {
                throw new MissingRequiredPropertyException("ServicePipelinesEmailArgs", "recipients");
            }
            return $;
        }
    }
