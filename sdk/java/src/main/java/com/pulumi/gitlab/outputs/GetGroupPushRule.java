...
@CustomType
public final class GetGroupPushRule {
    /**
    ...
    /**
     * @return Users can only push commits to projects in this group that were committed with one of their own verified emails.
     * 
     */
    private Boolean commitCommitterCheck;
    /**
     * @return Users can only push commits to projects in this group if the commit author name is consistent with their GitLab account name.
     * 
     */
    ...
    public static Builder builder(GetGroupPushRule defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean rejectUnsignedCommits;
        public Builder() {}
        public Builder(GetGroupPushRule defaults) {
        ...
        public Builder authorEmailRegex(String authorEmailRegex) {
            if (authorEmailRegex == null) {
              throw new MissingRequiredPropertyException("GetGroupPushRule", "authorEmailRegex");
            }
        ...
        public Builder branchNameRegex(String branchNameRegex) {
            if (branchNameRegex == null) {
              throw new MissingRequiredPropertyException("GetGroupPushRule", "branchNameRegex");
            }
        ...
        public Builder commitCommitterCheck(Boolean commitCommitterCheck) {
            if (commitCommitterCheck == null) {
              throw new MissingRequiredPropertyException("GetGroupPushRule", "commitCommitterCheck");
            }
        ...
        public Builder commitCommitterNameCheck(Boolean commitCommitterNameCheck) {
            if (commitCommitterNameCheck == null) {
              throw new MissingRequiredPropertyException("GetGroupPushRule", "commitCommitterNameCheck");
            }
        ...
        public Builder commitMessageNegativeRegex(String commitMessageNegativeRegex) {
            if (commitMessageNegativeRegex == null) {
              throw new MissingRequiredPropertyException("GetGroupPushRule", "commitMessageNegativeRegex");
            }
        ...
        public Builder commitMessageRegex(String commitMessageRegex) {
            if (commitMessageRegex == null) {
              throw new MissingRequiredPropertyException("GetGroupPushRule", "commitMessageRegex");
            }
        ...
        public Builder denyDeleteTag(Boolean denyDeleteTag) {
            if (denyDeleteTag == null) {
              throw new MissingRequiredPropertyException("GetGroupPushRule", "denyDeleteTag");
            }
        ...
        public Builder fileNameRegex(String fileNameRegex) {
            if (fileNameRegex == null) {
              throw new MissingRequiredPropertyException("GetGroupPushRule", "fileNameRegex");
            }
        ...
        public Builder maxFileSize(Integer maxFileSize) {
            if (maxFileSize == null) {
              throw new MissingRequiredPropertyException("GetGroupPushRule", "maxFileSize");
            }
        ...
        public Builder memberCheck(Boolean memberCheck) {
            if (memberCheck == null) {
              throw new MissingRequiredPropertyException("GetGroupPushRule", "memberCheck");
            }
        ...
        public Builder preventSecrets(Boolean preventSecrets) {
            if (preventSecrets == null) {
              throw new MissingRequiredPropertyException("GetGroupPushRule", "preventSecrets");
            }
        ...
        public Builder rejectNonDcoCommits(Boolean rejectNonDcoCommits) {
            if (rejectNonDcoCommits == null) {
              throw new MissingRequiredPropertyException("GetGroupPushRule", "rejectNonDcoCommits");
            }
        ...
        public Builder rejectUnsignedCommits(Boolean rejectUnsignedCommits) {
            if (rejectUnsignedCommits == null) {
              throw new MissingRequiredPropertyException("GetGroupPushRule", "rejectUnsignedCommits");
            }
            this.rejectUnsignedCommits = rejectUnsignedCommits;
            return this;
        }
        public GetGroupPushRule build() {
            final var _resultValue = new GetGroupPushRule();
