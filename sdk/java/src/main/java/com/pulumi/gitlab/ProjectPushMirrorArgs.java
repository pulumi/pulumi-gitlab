...
public final class ProjectPushMirrorArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProjectPushMirrorArgs Empty = new ProjectPushMirrorArgs();
    ...
    public static Builder builder(ProjectPushMirrorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectPushMirrorArgs();
        }

        public Builder(ProjectPushMirrorArgs defaults) {
            $ = new ProjectPushMirrorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProjectPushMirrorArgs build() {
            if ($.project == null) {
                throw new MissingRequiredPropertyException("ProjectPushMirrorArgs", "project");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("ProjectPushMirrorArgs", "url");
            }
            return $;
        }
    }
