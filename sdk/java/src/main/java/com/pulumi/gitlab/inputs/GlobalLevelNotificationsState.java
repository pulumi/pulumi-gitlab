...
public final class GlobalLevelNotificationsState extends com.pulumi.resources.ResourceArgs {

    public static final GlobalLevelNotificationsState Empty = new GlobalLevelNotificationsState();
    ...
    private GlobalLevelNotificationsState(GlobalLevelNotificationsState $) {
    ...
    public static Builder builder(GlobalLevelNotificationsState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GlobalLevelNotificationsState();
        }

        public Builder(GlobalLevelNotificationsState defaults) {
            $ = new GlobalLevelNotificationsState(Objects.requireNonNull(defaults));
        }
        ...
        public GlobalLevelNotificationsState build() {
            return $;
        }
    }
