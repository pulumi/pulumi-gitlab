...
public final class ProjectIntegrationMicrosoftTeamsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ProjectIntegrationMicrosoftTeamsArgs() {}

    private ProjectIntegrationMicrosoftTeamsArgs(ProjectIntegrationMicrosoftTeamsArgs $) {
    ...
    public static Builder builder(ProjectIntegrationMicrosoftTeamsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectIntegrationMicrosoftTeamsArgs();
        }

        public Builder(ProjectIntegrationMicrosoftTeamsArgs defaults) {
            $ = new ProjectIntegrationMicrosoftTeamsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProjectIntegrationMicrosoftTeamsArgs build() {
            if ($.project == null) {
                throw new MissingRequiredPropertyException("ProjectIntegrationMicrosoftTeamsArgs", "project");
            }
            if ($.webhook == null) {
                throw new MissingRequiredPropertyException("ProjectIntegrationMicrosoftTeamsArgs", "webhook");
            }
            return $;
        }
    }
