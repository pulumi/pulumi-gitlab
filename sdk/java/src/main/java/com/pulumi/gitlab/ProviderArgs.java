...
public final class ProviderArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The context to use for authentication and configuration. The context must exist in the configuration file. It may be
     * sourced from the `GITLAB_CONTEXT` environment variable.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param context The context to use for authentication and configuration. The context must exist in the configuration file. It may be
         * sourced from the `GITLAB_CONTEXT` environment variable.
         * 
         * @return builder
         * 
