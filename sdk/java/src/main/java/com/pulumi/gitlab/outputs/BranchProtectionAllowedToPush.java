...
public final class BranchProtectionAllowedToPush {
    ...
    public static Builder builder(BranchProtectionAllowedToPush defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer userId;
        public Builder() {}
        public Builder(BranchProtectionAllowedToPush defaults) {
        ...
        public BranchProtectionAllowedToPush build() {
            final var _resultValue = new BranchProtectionAllowedToPush();
