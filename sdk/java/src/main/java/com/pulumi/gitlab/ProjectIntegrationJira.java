...
import com.pulumi.gitlab.ProjectIntegrationJiraArgs;
import com.pulumi.gitlab.Utilities;
import com.pulumi.gitlab.inputs.ProjectIntegrationJiraState;
...
/**
 * The `gitlab.ProjectIntegrationJira` resource manages the lifecycle of a project integration with Jira.
 * 
 ...
 * import com.pulumi.gitlab.ProjectIntegrationJira;
 * import com.pulumi.gitlab.ProjectIntegrationJiraArgs;
 * import java.util.List;
 ...
 *             .build());
 * 
 *         var jira = new ProjectIntegrationJira("jira", ProjectIntegrationJiraArgs.builder()
 ...
 * 
 * You can import a gitlab.ProjectIntegrationJira state using the project ID, for example:
 * 
 * ```sh
 ...
 * 
 */
@ResourceType(type="gitlab:index/projectIntegrationJira:ProjectIntegrationJira")
public class ProjectIntegrationJira extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ProjectIntegrationJira(java.lang.String name) {
        this(name, ProjectIntegrationJiraArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ProjectIntegrationJira(java.lang.String name, ProjectIntegrationJiraArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ProjectIntegrationJira(java.lang.String name, ProjectIntegrationJiraArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gitlab:index/projectIntegrationJira:ProjectIntegrationJira", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ProjectIntegrationJira(java.lang.String name, Output<java.lang.String> id, @Nullable ProjectIntegrationJiraState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gitlab:index/projectIntegrationJira:ProjectIntegrationJira", name, state, makeResourceOptions(options, id), false);
    }

    private static ProjectIntegrationJiraArgs makeArgs(ProjectIntegrationJiraArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ProjectIntegrationJiraArgs.Empty : args;
    }
     ...
     */
    public static ProjectIntegrationJira get(java.lang.String name, Output<java.lang.String> id, @Nullable ProjectIntegrationJiraState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new ProjectIntegrationJira(name, id, state, options);
    }
}
