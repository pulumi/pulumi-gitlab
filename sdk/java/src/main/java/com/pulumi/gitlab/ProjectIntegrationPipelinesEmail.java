...
import com.pulumi.gitlab.inputs.ProjectIntegrationPipelinesEmailState;
 ...
 * ## Import
 * 
 * Starting in Terraform v1.5.0, you can use an import block to import `gitlab.ProjectIntegrationPipelinesEmail`. For example:
 * 
 * Importing using the CLI is supported with the following syntax:
 * 
 * You can import a gitlab.ProjectIntegrationPipelinesEmail state using the project ID, for example:
 * 
 * ```sh
...
public class ProjectIntegrationPipelinesEmail extends com.pulumi.resources.CustomResource {
     ...
     */
    public ProjectIntegrationPipelinesEmail(java.lang.String name) {
        this(name, ProjectIntegrationPipelinesEmailArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ProjectIntegrationPipelinesEmail(java.lang.String name, ProjectIntegrationPipelinesEmailArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ProjectIntegrationPipelinesEmail(java.lang.String name, ProjectIntegrationPipelinesEmailArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gitlab:index/projectIntegrationPipelinesEmail:ProjectIntegrationPipelinesEmail", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ProjectIntegrationPipelinesEmail(java.lang.String name, Output<java.lang.String> id, @Nullable ProjectIntegrationPipelinesEmailState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gitlab:index/projectIntegrationPipelinesEmail:ProjectIntegrationPipelinesEmail", name, state, makeResourceOptions(options, id), false);
    }

    private static ProjectIntegrationPipelinesEmailArgs makeArgs(ProjectIntegrationPipelinesEmailArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ProjectIntegrationPipelinesEmailArgs.Empty : args;
    }
     ...
     */
    public static ProjectIntegrationPipelinesEmail get(java.lang.String name, Output<java.lang.String> id, @Nullable ProjectIntegrationPipelinesEmailState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new ProjectIntegrationPipelinesEmail(name, id, state, options);
    }
}
