...
public final class InstanceServiceAccountTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceServiceAccountTimeoutsArgs Empty = new InstanceServiceAccountTimeoutsArgs();
    ...
    private InstanceServiceAccountTimeoutsArgs() {}

    private InstanceServiceAccountTimeoutsArgs(InstanceServiceAccountTimeoutsArgs $) {
        this.delete = $.delete;
    }
    ...
    public static Builder builder(InstanceServiceAccountTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceServiceAccountTimeoutsArgs();
        }

        public Builder(InstanceServiceAccountTimeoutsArgs defaults) {
            $ = new InstanceServiceAccountTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceServiceAccountTimeoutsArgs build() {
            return $;
        }
    }
