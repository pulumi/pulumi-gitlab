...
public final class GroupIntegrationJiraArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupIntegrationJiraArgs Empty = new GroupIntegrationJiraArgs();
    ...
    private GroupIntegrationJiraArgs() {}

    private GroupIntegrationJiraArgs(GroupIntegrationJiraArgs $) {
        this.apiUrl = $.apiUrl;
    ...
    public static Builder builder(GroupIntegrationJiraArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupIntegrationJiraArgs();
        }

        public Builder(GroupIntegrationJiraArgs defaults) {
            $ = new GroupIntegrationJiraArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param group ID or full path of the group you want to activate integration on.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param url The URL to the JIRA project which is being linked to this GitLab group. For example, https://jira.example.com.
         * 
         * @return builder
         * 
         */
        ...
        public GroupIntegrationJiraArgs build() {
            if ($.group == null) {
                throw new MissingRequiredPropertyException("GroupIntegrationJiraArgs", "group");
            }
            if ($.password == null) {
                throw new MissingRequiredPropertyException("GroupIntegrationJiraArgs", "password");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GroupIntegrationJiraArgs", "url");
            }
            return $;
        }
    }
