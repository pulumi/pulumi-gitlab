...
public final class GroupLevelMrApprovalsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupLevelMrApprovalsArgs Empty = new GroupLevelMrApprovalsArgs();
    ...
    private GroupLevelMrApprovalsArgs() {}

    private GroupLevelMrApprovalsArgs(GroupLevelMrApprovalsArgs $) {
    ...
    public static Builder builder(GroupLevelMrApprovalsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupLevelMrApprovalsArgs();
        }

        public Builder(GroupLevelMrApprovalsArgs defaults) {
            $ = new GroupLevelMrApprovalsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GroupLevelMrApprovalsArgs build() {
            if ($.group == null) {
                throw new MissingRequiredPropertyException("GroupLevelMrApprovalsArgs", "group");
            }
            return $;
        }
    }
