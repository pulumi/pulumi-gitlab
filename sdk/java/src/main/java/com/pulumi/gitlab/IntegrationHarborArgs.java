...
public final class IntegrationHarborArgs extends com.pulumi.resources.ResourceArgs {

    public static final IntegrationHarborArgs Empty = new IntegrationHarborArgs();
    ...
    private IntegrationHarborArgs() {}

    private IntegrationHarborArgs(IntegrationHarborArgs $) {
    ...
    public static Builder builder(IntegrationHarborArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IntegrationHarborArgs();
        }

        public Builder(IntegrationHarborArgs defaults) {
            $ = new IntegrationHarborArgs(Objects.requireNonNull(defaults));
        }
        ...
        public IntegrationHarborArgs build() {
            if ($.password == null) {
                throw new MissingRequiredPropertyException("IntegrationHarborArgs", "password");
            }
            if ($.project == null) {
                throw new MissingRequiredPropertyException("IntegrationHarborArgs", "project");
            }
            if ($.projectName == null) {
                throw new MissingRequiredPropertyException("IntegrationHarborArgs", "projectName");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("IntegrationHarborArgs", "url");
            }
            if ($.username == null) {
                throw new MissingRequiredPropertyException("IntegrationHarborArgs", "username");
            }
            return $;
        }
    }
