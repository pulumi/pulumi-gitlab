...
@CustomType
public final class GetSystemHooksHook {
    /**
    ...
    public static Builder builder(GetSystemHooksHook defaults) {
    ...
    public static final class Builder {
        ...
        private String url;
        public Builder() {}
        public Builder(GetSystemHooksHook defaults) {
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetSystemHooksHook", "createdAt");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetSystemHooksHook", "description");
            }
        ...
        public Builder enableSslVerification(Boolean enableSslVerification) {
            if (enableSslVerification == null) {
              throw new MissingRequiredPropertyException("GetSystemHooksHook", "enableSslVerification");
            }
        ...
        public Builder hookId(Integer hookId) {
            if (hookId == null) {
              throw new MissingRequiredPropertyException("GetSystemHooksHook", "hookId");
            }
            this.hookId = hookId;
            return this;
        }
        ...
        public Builder mergeRequestsEvents(Boolean mergeRequestsEvents) {
            if (mergeRequestsEvents == null) {
              throw new MissingRequiredPropertyException("GetSystemHooksHook", "mergeRequestsEvents");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetSystemHooksHook", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder pushEvents(Boolean pushEvents) {
            if (pushEvents == null) {
              throw new MissingRequiredPropertyException("GetSystemHooksHook", "pushEvents");
            }
        ...
        public Builder repositoryUpdateEvents(Boolean repositoryUpdateEvents) {
            if (repositoryUpdateEvents == null) {
              throw new MissingRequiredPropertyException("GetSystemHooksHook", "repositoryUpdateEvents");
            }
        ...
        public Builder signingTokenPresent(Boolean signingTokenPresent) {
            if (signingTokenPresent == null) {
              throw new MissingRequiredPropertyException("GetSystemHooksHook", "signingTokenPresent");
            }
        ...
        public Builder tagPushEvents(Boolean tagPushEvents) {
            if (tagPushEvents == null) {
              throw new MissingRequiredPropertyException("GetSystemHooksHook", "tagPushEvents");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("GetSystemHooksHook", "url");
            }
            this.url = url;
            return this;
        }
        public GetSystemHooksHook build() {
            final var _resultValue = new GetSystemHooksHook();
