...
public final class GroupIssueBoardListArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupIssueBoardListArgs Empty = new GroupIssueBoardListArgs();
    ...
    private GroupIssueBoardListArgs() {}

    private GroupIssueBoardListArgs(GroupIssueBoardListArgs $) {
        this.id = $.id;
    ...
    public static Builder builder(GroupIssueBoardListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupIssueBoardListArgs();
        }

        public Builder(GroupIssueBoardListArgs defaults) {
            $ = new GroupIssueBoardListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GroupIssueBoardListArgs build() {
            return $;
        }
    }
