...
import com.pulumi.gitlab.ProjectIntegrationMattermostArgs;
 ...
 * import com.pulumi.gitlab.ProjectIntegrationMattermost;
 * import com.pulumi.gitlab.ProjectIntegrationMattermostArgs;
 ...
 *             .build());
 * 
 *         var mattermost = new ProjectIntegrationMattermost("mattermost", ProjectIntegrationMattermostArgs.builder()
...
public class ProjectIntegrationMattermost extends com.pulumi.resources.CustomResource {
     ...
     */
    public ProjectIntegrationMattermost(java.lang.String name) {
        this(name, ProjectIntegrationMattermostArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ProjectIntegrationMattermost(java.lang.String name, ProjectIntegrationMattermostArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ProjectIntegrationMattermost(java.lang.String name, ProjectIntegrationMattermostArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gitlab:index/projectIntegrationMattermost:ProjectIntegrationMattermost", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ProjectIntegrationMattermost(java.lang.String name, Output<java.lang.String> id, @Nullable ProjectIntegrationMattermostState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gitlab:index/projectIntegrationMattermost:ProjectIntegrationMattermost", name, state, makeResourceOptions(options, id), false);
    }

    private static ProjectIntegrationMattermostArgs makeArgs(ProjectIntegrationMattermostArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ProjectIntegrationMattermostArgs.Empty : args;
    }
     ...
     */
    public static ProjectIntegrationMattermost get(java.lang.String name, Output<java.lang.String> id, @Nullable ProjectIntegrationMattermostState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
