...
public final class GroupBranchProtectionAllowedToMergeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupBranchProtectionAllowedToMergeArgs Empty = new GroupBranchProtectionAllowedToMergeArgs();
    ...
    private GroupBranchProtectionAllowedToMergeArgs() {}

    private GroupBranchProtectionAllowedToMergeArgs(GroupBranchProtectionAllowedToMergeArgs $) {
    ...
    public static Builder builder(GroupBranchProtectionAllowedToMergeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupBranchProtectionAllowedToMergeArgs();
        }

        public Builder(GroupBranchProtectionAllowedToMergeArgs defaults) {
            $ = new GroupBranchProtectionAllowedToMergeArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param accessLevel Access level allowed to perform the relevant action. Mutually exclusive with `groupId` and `userId`. Valid values are: `no one`, `developer`, `maintainer`, `admin`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param groupId The ID of a GitLab group allowed to perform the relevant action. Mutually exclusive with `userId` and `accessLevel`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param userId The ID of a GitLab user allowed to perform the relevant action. Mutually exclusive with `groupId` and `accessLevel`.
         * 
         * @return builder
         * 
         */
        ...
        public GroupBranchProtectionAllowedToMergeArgs build() {
            return $;
        }
    }
