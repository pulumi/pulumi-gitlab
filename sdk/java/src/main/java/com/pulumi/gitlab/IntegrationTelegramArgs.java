...
public final class IntegrationTelegramArgs extends com.pulumi.resources.ResourceArgs {

    public static final IntegrationTelegramArgs Empty = new IntegrationTelegramArgs();
    ...
    private IntegrationTelegramArgs() {}

    private IntegrationTelegramArgs(IntegrationTelegramArgs $) {
    ...
    public static Builder builder(IntegrationTelegramArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IntegrationTelegramArgs();
        }

        public Builder(IntegrationTelegramArgs defaults) {
            $ = new IntegrationTelegramArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param branchesToBeNotified Branches to send notifications for (introduced in GitLab 16.5). Update of this attribute was not supported before Gitlab 16.11 due to API bug. Valid options are `all`, `default`, `protected`, `default_and_protected`.
         * 
         * @return builder
         * 
         */
        ...
        public IntegrationTelegramArgs build() {
            if ($.confidentialIssuesEvents == null) {
                throw new MissingRequiredPropertyException("IntegrationTelegramArgs", "confidentialIssuesEvents");
            }
            if ($.confidentialNoteEvents == null) {
                throw new MissingRequiredPropertyException("IntegrationTelegramArgs", "confidentialNoteEvents");
            }
            if ($.issuesEvents == null) {
                throw new MissingRequiredPropertyException("IntegrationTelegramArgs", "issuesEvents");
            }
            if ($.mergeRequestsEvents == null) {
                throw new MissingRequiredPropertyException("IntegrationTelegramArgs", "mergeRequestsEvents");
            }
            if ($.noteEvents == null) {
                throw new MissingRequiredPropertyException("IntegrationTelegramArgs", "noteEvents");
            }
            if ($.pipelineEvents == null) {
                throw new MissingRequiredPropertyException("IntegrationTelegramArgs", "pipelineEvents");
            }
            if ($.project == null) {
                throw new MissingRequiredPropertyException("IntegrationTelegramArgs", "project");
            }
            if ($.pushEvents == null) {
                throw new MissingRequiredPropertyException("IntegrationTelegramArgs", "pushEvents");
            }
            if ($.room == null) {
                throw new MissingRequiredPropertyException("IntegrationTelegramArgs", "room");
            }
            if ($.tagPushEvents == null) {
                throw new MissingRequiredPropertyException("IntegrationTelegramArgs", "tagPushEvents");
            }
            if ($.token == null) {
                throw new MissingRequiredPropertyException("IntegrationTelegramArgs", "token");
            }
            if ($.wikiPageEvents == null) {
                throw new MissingRequiredPropertyException("IntegrationTelegramArgs", "wikiPageEvents");
            }
            return $;
        }
    }
