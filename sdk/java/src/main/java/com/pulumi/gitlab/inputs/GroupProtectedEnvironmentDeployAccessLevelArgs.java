...
public final class GroupProtectedEnvironmentDeployAccessLevelArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param groupId The ID of the group allowed to deploy to this protected environment. The group must be a sub-group under the given group.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param userId The ID of the user allowed to deploy to this protected environment. The user must be a member of the group with Maintainer role or higher.
         * 
         * @return builder
         * 
         */
