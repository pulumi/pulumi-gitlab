...
public final class GroupProtectedEnvironmentDeployAccessLevelArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupProtectedEnvironmentDeployAccessLevelArgs Empty = new GroupProtectedEnvironmentDeployAccessLevelArgs();
    ...
    /**
     * @return The ID of the group allowed to deploy to this protected environment. The group must be a sub-group under the given group. Mutually exclusive with `access_level` and `user_id`.
     * 
     */
    ...
    /**
     * @return The ID of the user allowed to deploy to this protected environment. The user must be a member of the group with Maintainer role or higher. Mutually exclusive with `access_level` and `group_id`.
     * 
     */
    ...
    private GroupProtectedEnvironmentDeployAccessLevelArgs() {}

    private GroupProtectedEnvironmentDeployAccessLevelArgs(GroupProtectedEnvironmentDeployAccessLevelArgs $) {
    ...
    public static Builder builder(GroupProtectedEnvironmentDeployAccessLevelArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupProtectedEnvironmentDeployAccessLevelArgs();
        }

        public Builder(GroupProtectedEnvironmentDeployAccessLevelArgs defaults) {
            $ = new GroupProtectedEnvironmentDeployAccessLevelArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param groupId The ID of the group allowed to deploy to this protected environment. The group must be a sub-group under the given group. Mutually exclusive with `access_level` and `user_id`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param userId The ID of the user allowed to deploy to this protected environment. The user must be a member of the group with Maintainer role or higher. Mutually exclusive with `access_level` and `group_id`.
         * 
         * @return builder
         * 
         */
        ...
        public GroupProtectedEnvironmentDeployAccessLevelArgs build() {
            return $;
        }
    }
