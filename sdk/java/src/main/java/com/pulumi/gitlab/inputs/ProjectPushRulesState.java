...
public final class ProjectPushRulesState extends com.pulumi.resources.ResourceArgs {

    public static final ProjectPushRulesState Empty = new ProjectPushRulesState();
    ...
    private ProjectPushRulesState(ProjectPushRulesState $) {
    ...
    public static Builder builder(ProjectPushRulesState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectPushRulesState();
        }

        public Builder(ProjectPushRulesState defaults) {
            $ = new ProjectPushRulesState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param rejectUnsignedCommits Reject commit when it’s not signed.
         * 
         * @return builder
         * 
         */
        ...
        public ProjectPushRulesState build() {
            return $;
        }
    }
