...
import com.pulumi.gitlab.ProjectIntegrationEmailsOnPushArgs;
 ...
 * import com.pulumi.gitlab.ProjectIntegrationEmailsOnPush;
 * import com.pulumi.gitlab.ProjectIntegrationEmailsOnPushArgs;
 ...
 * ## Import
 * 
 * Starting in Terraform v1.5.0, you can use an import block to import `gitlab.ProjectIntegrationEmailsOnPush`. For example:
 * 
 ...
 * 
 */
@ResourceType(type="gitlab:index/projectIntegrationEmailsOnPush:ProjectIntegrationEmailsOnPush")
public class ProjectIntegrationEmailsOnPush extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ProjectIntegrationEmailsOnPush(java.lang.String name) {
        this(name, ProjectIntegrationEmailsOnPushArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ProjectIntegrationEmailsOnPush(java.lang.String name, ProjectIntegrationEmailsOnPushArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ProjectIntegrationEmailsOnPush(java.lang.String name, ProjectIntegrationEmailsOnPushArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gitlab:index/projectIntegrationEmailsOnPush:ProjectIntegrationEmailsOnPush", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ProjectIntegrationEmailsOnPush(java.lang.String name, Output<java.lang.String> id, @Nullable ProjectIntegrationEmailsOnPushState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gitlab:index/projectIntegrationEmailsOnPush:ProjectIntegrationEmailsOnPush", name, state, makeResourceOptions(options, id), false);
    }

    private static ProjectIntegrationEmailsOnPushArgs makeArgs(ProjectIntegrationEmailsOnPushArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ProjectIntegrationEmailsOnPushArgs.Empty : args;
    }
     ...
     */
    public static ProjectIntegrationEmailsOnPush get(java.lang.String name, Output<java.lang.String> id, @Nullable ProjectIntegrationEmailsOnPushState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
