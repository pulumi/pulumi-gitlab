...
public final class GroupShareGroupArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param groupAccess The access level to grant the group. Valid values are: `no one`, `minimal`, `guest`, `reporter`, `developer`, `maintainer`, `owner`, `master`
         * 
         * @return builder
         * 
         */
        ...
        public GroupShareGroupArgs build() {
            $.groupAccess = Objects.requireNonNull($.groupAccess, "expected parameter 'groupAccess' to be non-null");
            $.groupId = Objects.requireNonNull($.groupId, "expected parameter 'groupId' to be non-null");
            $.shareGroupId = Objects.requireNonNull($.shareGroupId, "expected parameter 'shareGroupId' to be non-null");
            return $;
        }
    }
