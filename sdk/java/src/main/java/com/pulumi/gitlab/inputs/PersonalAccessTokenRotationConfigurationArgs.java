...
public final class PersonalAccessTokenRotationConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final PersonalAccessTokenRotationConfigurationArgs Empty = new PersonalAccessTokenRotationConfigurationArgs();
    ...
    private PersonalAccessTokenRotationConfigurationArgs() {}

    private PersonalAccessTokenRotationConfigurationArgs(PersonalAccessTokenRotationConfigurationArgs $) {
    ...
    public static Builder builder(PersonalAccessTokenRotationConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PersonalAccessTokenRotationConfigurationArgs();
        }

        public Builder(PersonalAccessTokenRotationConfigurationArgs defaults) {
            $ = new PersonalAccessTokenRotationConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PersonalAccessTokenRotationConfigurationArgs build() {
            if ($.expirationDays == null) {
                throw new MissingRequiredPropertyException("PersonalAccessTokenRotationConfigurationArgs", "expirationDays");
            }
            if ($.rotateBeforeDays == null) {
                throw new MissingRequiredPropertyException("PersonalAccessTokenRotationConfigurationArgs", "rotateBeforeDays");
            }
            return $;
        }
    }
