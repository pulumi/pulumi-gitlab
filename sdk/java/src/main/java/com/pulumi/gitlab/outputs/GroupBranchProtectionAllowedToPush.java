...
@CustomType
public final class GroupBranchProtectionAllowedToPush {
    /**
    ...
    private GroupBranchProtectionAllowedToPush() {}
    /**
     * @return Access level allowed to perform the relevant action. Mutually exclusive with `deployKeyId`, `groupId`, and `userId`. Valid values are: `no one`, `developer`, `maintainer`, `admin`.
     * 
     */
    ...
    public static Builder builder(GroupBranchProtectionAllowedToPush defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer userId;
        public Builder() {}
        public Builder(GroupBranchProtectionAllowedToPush defaults) {
        ...
        public GroupBranchProtectionAllowedToPush build() {
            final var _resultValue = new GroupBranchProtectionAllowedToPush();
