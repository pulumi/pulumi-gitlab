...
public final class ReleaseCommit {
    ...
    public static Builder builder(ReleaseCommit defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String title;
        public Builder() {}
        public Builder(ReleaseCommit defaults) {
        ...
        public ReleaseCommit build() {
            final var _resultValue = new ReleaseCommit();
