...
import com.pulumi.gitlab.inputs.IntegrationRedmineState;
...
public class IntegrationRedmine extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public IntegrationRedmine(java.lang.String name) {
        this(name, IntegrationRedmineArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public IntegrationRedmine(java.lang.String name, IntegrationRedmineArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public IntegrationRedmine(java.lang.String name, IntegrationRedmineArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gitlab:index/integrationRedmine:IntegrationRedmine", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private IntegrationRedmine(java.lang.String name, Output<java.lang.String> id, @Nullable IntegrationRedmineState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gitlab:index/integrationRedmine:IntegrationRedmine", name, state, makeResourceOptions(options, id), false);
    }

    private static IntegrationRedmineArgs makeArgs(IntegrationRedmineArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? IntegrationRedmineArgs.Empty : args;
    }
     ...
     */
    public static IntegrationRedmine get(java.lang.String name, Output<java.lang.String> id, @Nullable IntegrationRedmineState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
