...
public class ServiceExternalWiki extends com.pulumi.resources.CustomResource {
     ...
     */
    public ServiceExternalWiki(java.lang.String name) {
     ...
     */
    public ServiceExternalWiki(java.lang.String name, ServiceExternalWikiArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ServiceExternalWiki(java.lang.String name, ServiceExternalWikiArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gitlab:index/serviceExternalWiki:ServiceExternalWiki", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ServiceExternalWiki(java.lang.String name, Output<java.lang.String> id, @Nullable ServiceExternalWikiState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gitlab:index/serviceExternalWiki:ServiceExternalWiki", name, state, makeResourceOptions(options, id), false);
    }

    private static ServiceExternalWikiArgs makeArgs(ServiceExternalWikiArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ServiceExternalWikiArgs.Empty : args;
    }
     ...
     */
    public static ServiceExternalWiki get(java.lang.String name, Output<java.lang.String> id, @Nullable ServiceExternalWikiState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
