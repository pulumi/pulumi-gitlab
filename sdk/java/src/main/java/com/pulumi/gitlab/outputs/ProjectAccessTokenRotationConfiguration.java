...
@CustomType
public final class ProjectAccessTokenRotationConfiguration {
    /**
    ...
    private ProjectAccessTokenRotationConfiguration() {}
    /**
     * @return The duration (in days) the new token should be valid for.
     * 
     */
    ...
    public static Builder builder(ProjectAccessTokenRotationConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer rotateBeforeDays;
        public Builder() {}
        public Builder(ProjectAccessTokenRotationConfiguration defaults) {
        ...
        public Builder expirationDays(Integer expirationDays) {
            if (expirationDays == null) {
              throw new MissingRequiredPropertyException("ProjectAccessTokenRotationConfiguration", "expirationDays");
            }
        ...
        public Builder rotateBeforeDays(Integer rotateBeforeDays) {
            if (rotateBeforeDays == null) {
              throw new MissingRequiredPropertyException("ProjectAccessTokenRotationConfiguration", "rotateBeforeDays");
            }
            this.rotateBeforeDays = rotateBeforeDays;
            return this;
        }
        public ProjectAccessTokenRotationConfiguration build() {
            final var _resultValue = new ProjectAccessTokenRotationConfiguration();
